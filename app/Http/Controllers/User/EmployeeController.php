...
class EmployeeController extends Controller
{
    ...
    public function employee(){
        ...
        $data['view'] = 'hr_pro.employee.employee';
    ...
    public function existing_employee_detail(){
        ...
        $data['view'] = 'hr_pro.employee.existing_employee_detail';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function add_employee(){
        ...
        $data['view'] = 'hr_pro.employee.add_employee';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function save_employee(Request $request){
        ...
        if($employee->save()){
             ...
             return \Redirect::route('user.hr_pro.employee')->with('success', 'Data Added Sucessfully');
        }else{
            return \Redirect::route('user.hr_pro.employee')->with('error', 'Data not added sucessfully');
        }
    ...
    public function pending_employee(){
        ...
        $data['view'] = 'hr_pro.employee.pending_employee';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function edit_employee (Request $request){
        ...
        $data['view'] = 'hr_pro.employee.edit_employee';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function view_employee (Request $request){
        ...
        $data['view'] = 'hr_pro.employee.view_employee';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function add_salary_card(Request $request){
        ...
        $data['view'] = 'hr_pro.employee.salary_card.add_salary_card';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function pending_employee_for_joining(){
        ...
        $data['view'] = 'hr_pro.employee.employee_joining';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function employee_doj(Request $request){
        ...
        $this->history_table('employee_histories', "Employee Joined " ,  Auth::id() ,  $data['employee']->id, "hr_pro.view_employee");
        
        return \Redirect::route('user.hr_pro.employee')->with('success', 'Employee Joined  sucessfully');
    }
    ...
    public function existing_employee(){
        ...
        $data['page_title'] = "Existing Employee";
        $data['view'] = 'hr_pro.employee.existing_employee';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function delete_employee_status(Request $request){
        ...
        if( $employee->save()){
            ...
            $this->history_table('employee_histories', $employee->action ,  $employee->user_id , $employee->id , 'hr_pro.view_employee');
    ...
    public function employee_terminate(){
        ...
        $data['view'] = 'hr_pro.employee.termination.termination';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function trash_employee_termination(){
        ...
        $data['view'] = 'hr_pro.employee.termination.deleted_data';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function add_employee_termination(){
        ...
        $data['view'] = 'hr_pro.employee.termination.add_termination';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function view_employee_termination(Request $request){
        ...
        $data['view'] = 'hr_pro.employee.termination.view_termination';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function edit_employee_termination (Request $request){
        ...
        $data['view'] = 'hr_pro.employee.termination.edit_termination';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function save_employee_termination(Request $request){
        ...
        if($employee_termination->save()){
            ...
            return \Redirect::route('user.hr_pro.employee_terminate')->with('success', 'Data Added Sucessfully');
        }
    ...
    public function update_employee_termination(Request $request){
        ...
        return \Redirect::route('user.hr_pro.employee_terminate')->with('success', 'Data Updated Sucessfully');
    ...
    public function employee_suspension(){
        ...
        $data['view'] = 'hr_pro.employee.suspension.suspension';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function trash_employee_suspension(){
        ...
        $data['view'] = 'hr_pro.employee.suspension.deleted_data';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function add_employee_suspension(){
        ...
        $data['view'] = 'hr_pro.employee.suspension.add_suspension';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function view_employee_suspension(Request $request){
        ...
        $data['permission'] =  Permissions::where('role_id', '=', $user->role_id)->get();$user = Auth::user();
        $data['permissions'] =  Permissions::where('role_id', '=', $user->role_id)->where('module_id' ,'=' , 1)->first();
        ...
        $data['view'] = 'hr_pro.employee.suspension.view_suspension';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function edit_employee_suspension (Request $request){
        ...
        $data['view'] = 'hr_pro.employee.suspension.edit_suspension';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function save_employee_suspension(Request $request){
        ...
        $employee_suspension->user_id = Auth::id();
        
        $employee_suspension->action="Add";
       


        if($employee_suspension->save()){
            
            return \Redirect::route('user.hr_pro.employee_suspension')->with('success', 'Data Added Sucessfully');
        }
    ...
    public function update_employee_suspension(Request $request){
        ...
        return \Redirect::route('user.hr_pro.employee_suspension')->with('success', 'Data Updated Sucessfully');
    ...
    public function employee_renewals(){
        ...
        $data['view'] = 'hr_pro.employee.renewals.renewals';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function trash_employee_renewals(){
        ...
        $data['view'] = 'hr_pro.employee.renewals.deleted_data';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function add_employee_renewals(){
        ...
        $data['view'] = 'hr_pro.employee.renewals.add_renewals';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function view_employee_renewals(Request $request){
        ...
        $data['view'] = 'hr_pro.employee.renewals.view_renewals';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function edit_employee_renewals (Request $request){
        ...
        $data['view'] = 'hr_pro.employee.renewals.edit_renewals';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function save_employee_renewals(Request $request){
        ...
        $employee_termination->action="Add";
        ...
        if($employee_termination->save()){
            ...
            return \Redirect::route('user.hr_pro.employee_renewals')->with('success', 'Data Added Sucessfully');
        }
    ...
    public function update_employee_renewals(Request $request){
        ...
        return \Redirect::route('user.hr_pro.employee_renewals')->with('success', 'Data Updated Sucessfully');
    ...
    public function employee_increments(){
        ...
        $data['view'] = 'hr_pro.employee.increments.increments';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function trash_employee_increments(){
        ...
        $data['view'] = 'hr_pro.employee.increments.deleted_data';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function add_employee_increments(){
        ...
        $data['view'] = 'hr_pro.employee.increments.add_increments';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function view_employee_increments(Request $request){
        ...
        $data['view'] = 'hr_pro.employee.increments.view_increments';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function edit_employee_increments (Request $request){
        ...
        $data['view'] = 'hr_pro.employee.increments.edit_increments';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function save_employee_increments(Request $request){
        ...
        if($employee_termination->save()){
            ...
            return \Redirect::route('user.hr_pro.employee_increments')->with('success', 'Data Added Sucessfully');
        }
    ...
    public function update_employee_increments(Request $request){
        ...
        return \Redirect::route('user.hr_pro.employee_increments')->with('success', 'Data Updated Sucessfully');
    ...
    public function employee_deduction(){
        ...
        $data['view'] = 'hr_pro.employee.deduction.deduction';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function trash_employee_deduction(){
        ...
        $data['view'] = 'hr_pro.employee.deduction.deleted_data';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function add_employee_deduction(){
        ...
        $data['view'] = 'hr_pro.employee.deduction.add_deduction';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function view_employee_deduction(Request $request){
        ...
        $data['view'] = 'hr_pro.employee.deduction.view_deduction';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function edit_employee_deduction (Request $request){
        ...
        $data['page_title'] = "Edit Employee Renewal Request";
        $data['view'] = 'hr_pro.employee.deduction.edit_deduction';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function save_employee_deduction(Request $request){
        ...
        if($employee_termination->save()){
            $this->history_table('employee_deduction_histories', 'Add' ,Auth::id() , $employee_termination->id , 'hr_pro.view_employee_deduction');
            return \Redirect::route('user.hr_pro.employee_deduction')->with('success', 'Data Added Sucessfully');
        }
    ...
    public function update_employee_deduction(Request $request){
        ...
        return \Redirect::route('user.hr_pro.employee_deduction')->with('success', 'Data Updated Sucessfully');
    ...
    public function employee_attendence(){
        ...
        $data['modules']= DB::table('modules')->get();
        $data['employee'] = Employee::all();
        $data['attendance'] = Attendence::where('categorie' , '=' ,'office')->get();
        $user = Auth::user();
        $data['permissions'] =  Permissions::where('role_id', '=', $user->role_id)->where('module_id' ,'=' , 1)->first();
        ...
        $data['view'] = 'hr_pro.employee.attendance.attendance';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function employee_leave(){
        ...
        $data['view'] = 'hr_pro.employee.attendance.leave.leave';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function trash_employee_leave(){
        ...
        $data['view'] = 'hr_pro.employee.attendance.leave.deleted_data';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function add_employee_leave(){
        ...
        $data['view'] = 'hr_pro.employee.attendance.leave.add_leave';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function view_employee_leave(Request $request){
        ...
        $data['view'] = 'hr_pro.employee.attendance.leave.view_leave';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function edit_employee_leave (Request $request){
        ...
        $data['view'] = 'hr_pro.employee.attendance.leave.edit_leave';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function save_employee_leave(Request $request){
        ...
        if($leave->save()){
            $this->history_table('leave_histories', 'Add' , Auth::id() , $leave->id , 'hr_pro.view_employee_leave');
            return \Redirect::route('user.hr_pro.employee_leave')->with('success', 'Data Added Sucessfully');
        }
    ...
    public function update_employee_leave(Request $request){
        ...
        return \Redirect::route('user.hr_pro.employee_leave')->with('success', 'Data Updated Sucessfully');
    ...
    public function employee_attendence_mark($date=null){
        ...
        $data['permission'] =  Permissions::where('role_id', '=', $user->role_id)->get();
            $data['employee'] = Employee::where('designation', '=',"office")->get();
            // dd($data['employee']);
            $data['date'] = $date;

        
            $data['page_title'] = "Attendance";
            $data['view'] = 'hr_pro.employee.attendance.mark_attendance';
            return view('users.layout', ["data"=>$data]);
    }
    ...
    public function save_employee_attendance(Request $request){
        ...
        foreach($request->input('attendance') as $key => $value){
            ...
            if($value == 'a'){
                ...
                $absent->date =   $date;
                $absent->status =  'new';
                $absent->categorie = 'office';

                $absent->row_status = 'active';
                $absent->save();
                $this->history_table('absent_histories', 'add' , Auth::id() , $absent->id , 'hr_pro.employee_attendence');
        ...
        return \Redirect::route('user.hr_pro.employee_attendence')->with('success', 'Data Added Sucessfully');
    ...
    public function employee_attendence_report(){
        ...
        $data['view'] = 'hr_pro.employee.attendance.attendance_report';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function employee_funds(){
        ...
        $data['view'] = 'hr_pro.employee.funds.funds';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function trash_employee_funds(){
        ...
        $data['view'] = 'hr_pro.employee.funds.deleted_data';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function add_employee_funds(){
        ...
        $data['view'] = 'hr_pro.employee.funds.add_funds';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function view_employee_funds(Request $request){
        ...
        $data['view'] = 'hr_pro.employee.funds.view_funds';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function edit_employee_funds (Request $request){
        ...
        $data['view'] = 'hr_pro.employee.funds.edit_funds';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function update_employee_funds(Request $request){
        ...
        return \Redirect::route('user.hr_pro.employee_funds')->with('success', 'Data Updated Sucessfully');
    ...
    public function complaints(){
        ...
        $data['view'] = 'hr_pro.employee.complaints.complaints';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function trash_complaints(){
        ...
        $data['view'] = 'hr_pro.employee.complaints.deleted_data';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function add_complaints(){
        ...
        $data['view'] = 'hr_pro.employee.complaints.add_complaints';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function view_complaints(Request $request){
        ...
        $data['view'] = 'hr_pro.employee.complaints.view_complaints';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function edit_complaints (Request $request){
        ...
        $data['view'] = 'hr_pro.employee.complaints.edit_complaints';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function save_complaints(Request $request){
        ...
        $Complaints->status = 'pending_admin';
        ...
        if($Complaints->save()){
            ...
            return \Redirect::route('user.hr_pro.complaints')->with('success', 'Data Added Sucessfully');
        }
    ...
    public function update_complaints(Request $request){
        ...
        return \Redirect::route('user.hr_pro.complaints')->with('success', 'Data Updated Sucessfully');
    ...
    public function absent(){
        ...
        $data['view'] = 'hr_pro.employee.absent.absent';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function trash_absent(){
        ...
        $data['view'] = 'hr_pro.employee.absent.deleted_data';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function add_absent(){
        ...
        $data['view'] = 'hr_pro.employee.absent.add_absent';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function view_absent(Request $request){
        ...
        $data['view'] = 'hr_pro.employee.absent.view_absent';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function edit_absent (Request $request){
        ...
        $data['view'] = 'hr_pro.employee.absent.edit_absent';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function save_absent(Request $request){
        ...
        if($absent->save()){
            ...
            return \Redirect::route('user.absent.absent')->with('success', 'Data Added Sucessfully');
        }
    ...
    public function update_absent(Request $request){
        ...
        $absent->status = $request->input('status');
        ...
        $this->history_table('absent_histories', 'Edit' , Auth::id() , $absent->id , 'hr_pro.view_absent');

        return \Redirect::route('user.hr_pro.absent')->with('success', 'Data Updated Sucessfully');
    ...
    public function delete_absent_status(Request $request){
        ...
        $absent->status = 'pending';
        $absent->row_status = 'pending';

 
        $absent->user_id = Auth::id();
        
        $absent->action="Delete";
        $this->history_table('absent_histories', 'Delete' , Auth::id() , $absent->id , 'hr_pro.view_absent');
        if( $absent->save()){
