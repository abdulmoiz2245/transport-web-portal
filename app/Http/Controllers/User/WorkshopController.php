...
class WorkshopController extends Controller
{
    ...
    public function job_card(){
        ...
        $data['view'] = 'workshop.job_card.job_card';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function trash_job_card(){
        ...
        $data['view'] = 'workshop.job_card.deleted_data';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function add_job_card(){
        ...
        $data['view'] = 'workshop.job_card.add_job_card';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function view_job_card(Request $request){
        ...
        $data['view'] = 'workshop.job_card.view_job_card';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function edit_job_card (Request $request){
        ...
        $data['view'] = 'workshop.job_card.edit_job_card';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function save_job_card(Request $request){
        ...
        if($job_card->save()){
            ...
            return \Redirect::route('user.workshop.job_card')->with('success', 'Data Added Sucessfully');
        }
    ...
    public function update_job_card(Request $request){
        ...
        if($job_card->save()){
            ...
            return \Redirect::route('user.workshop.job_card')->with('success', 'Data Updated Sucessfully');
        }
    ...
    public function vehicle_maintainace_schedule(){
        ...
        $data['view'] = 'workshop.vehicle_maintainace_schedule.vehicle_maintainace_schedule';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function vehicle_oil_change_detail(){
        ...
        $data['view'] = 'workshop.vehicle_maintainace_schedule.vehicle_oil_change_detail';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function preventive_check_list(){
        ...
        $data['view'] = 'workshop.vehicle_maintainace_schedule.preventive_check_list.preventive_check_list';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function trash_preventive_check_list(){
        ...
        $data['view'] = 'workshop.vehicle_maintainace_schedule.preventive_check_list.deleted_data';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function add_preventive_check_list(){
        ...
        $data['view'] = 'workshop.vehicle_maintainace_schedule.preventive_check_list.add_preventive_check_list';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function view_preventive_check_list(Request $request){
        ...
        $data['view'] = 'workshop.vehicle_maintainace_schedule.preventive_check_list.view_preventive_check_list';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function edit_preventive_check_list (Request $request){
        ...
        $data['view'] = 'workshop.vehicle_maintainace_schedule.preventive_check_list.edit_preventive_check_list';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function save_preventive_check_list(Request $request){
        ...
        if($preventive_check_list->save()){
            ...
            return \Redirect::route('user.workshop.preventive_check_list')->with('success', 'Data Added Sucessfully');
        }
    ...
    public function update_preventive_check_list(Request $request){
        ...
        if($preventive_check_list->save()){
            ...
            return \Redirect::route('user.workshop.preventive_check_list')->with('success', 'Data Updated Sucessfully');
        }
    ...
    public function vehicle_maintenance_detail(){
        ...
        $data['view'] = 'workshop.job_card.vehicle_maintenance_detail';
        return view('users.layout', ["data"=>$data]);
    }
}