...
class InventoryController extends Controller
{
    ...
    public function save_fuel_reading(Request $request){
        ...
        $fuel_reading->user_id = Auth::id();
        $fuel_reading->row_status = 'active';

        if($fuel_reading->save()){
            // $this->history_table('fuel_entery_histories', 'Add' , Auth::id() , $fuel_reading->id , 'hr_pro.edit_trade_license__sponsors__partners');
            ...
            $this->history_table('fuel_transfer_histories', 'Add' ,   Auth::id() , $fuel_reading->id , 'inventory.fuel.readings.edit_fuel_reading');

            return \Redirect::route('user.inventory.fuel.readings')->with('success', 'Data Added Sucessfully');
        }
    ...
    public function update_fuel_reading(Request $request){
        ...
        if($fuel_reading->save()){
            ...
            $this->history_table('fuel_transfer_histories', 'Edited' ,   Auth::id() , $fuel_reading->id , 'inventory.fuel.readings.edit_fuel_reading');
    ...
    public function trash_fuel_reading(){
        ...
        $data['view'] = 'inventory.fuel.deleted_data';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function delete_fuel_reading_status(Request $request){
        ...
        if( $office_contract->save()){
            ...
            $this->history_table('fuel_transfer_histories', 'Delete' ,   Auth::id(), $office_contract->id , 'inventory.fuel.readings.edit_fuel_reading');
            return response()->json(['status'=>'1']);
        }else{
    ...
    public function restore_fuel_reading(Request $request){
        ...
        $this->history_table('fuel_transfer_histories', 'Restored' ,  Auth::id() , $office_contract->id , 'inventory.fuel.readings.edit_fuel_reading');
    ...
    public function trash_used_tyres(){
        ...
        $data['view'] = 'inventory.tyres.deleted_data';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function update_used_tyres(Request $request){
        ...
        if($tyre->save()){
            $this->history_table('inventory__tyre_histories', 'Edit' ,   Auth::id() , $tyre->id , 'inventory.tyres.edit_used_tyres');
            return \Redirect::route('user.inventory.tyres.new_used_tyres')->with('success', 'Data Updated Sucessfully');
        }
    ...
    public function save_used_tyres(Request $request){
        ...
        $tyre->status = 'old';
        if($tyre->save()){
            $this->history_table('inventory__tyre_histories', 'Add Used' ,   Auth::id() , $tyre->id , 'inventory.tyres.edit_used_tyres');
            return \Redirect::route('user.inventory.tyres.new_used_tyres')->with('success', 'Data Added Sucessfully');
        }
    ...
    public function delete_used_tyres_status(Request $request){
        ...
        $this->history_table('inventory__tyre_histories', 'Delete' ,   Auth::id() , $customer_info->id , 'inventory.tyres.edit_used_tyres');
    ...
    public function restore_used_tyres(Request $request){
        ...
        $this->history_table('inventory__tyre_histories', 'Restored' ,   Auth::id() , $customer_info->id , 'inventory.tyres.edit_used_tyres');
    ...
    public function update_complain_tyres(Request $request){
        ...
        if($tyre->save()){
            $this->history_table('inventory__tyre_histories', 'Edit Complain ' ,   Auth::id() , $tyre->id , 'inventory.tyres.edit_used_tyres');
            return \Redirect::route('user.inventory.tyres.complain_tyres')->with('success', 'Data Updated Sucessfully');
        }
    ...
    public function save_complain_tyres(Request $request){
        ...
        $tyre->action = 'pending';
        if($tyre->save()){
            $this->history_table('inventory__tyre_histories', 'Add Complain' ,   Auth::id() , $tyre->id , 'inventory.tyres.edit_used_tyres');
            return \Redirect::route('user.inventory.tyres.complain_tyres')->with('success', 'Data Added Sucessfully');
        }
    ...
    public function save_tyres_entry(Request $request){
        ...
        foreach($request->input('tyre_serial') as $element )
        {
            ...
            if($tyre->save()){
                $this->history_table('inventory__tyre_histories', 'Add Tyre Entery' ,   Auth::id() , $tyre->id , 'inventory.tyres.edit_used_tyres');
                
            }
        }

        return \Redirect::route('user.inventory.tyres.tyres_entry')->with('success', 'Data Added Sucessfully');
    ...
    public function update_tyres_entry(Request $request){
        ...
        // dd( $request->input('tyre_serial'));
            ...
            if($tyre->save()){
                $this->history_table('inventory__tyre_histories', 'Edited Tyre Entery ' ,   Auth::id() , $tyre->id , 'inventory.tyres.edit_used_tyres');
                return \Redirect::route('user.inventory.tyres.tyres_entry')->with('success', 'Data Added Sucessfully');
            }
    ...
    public function update_spare_parts_in_storage(Request $request){
        ...
        if($spare_part->save()){
            $this->history_table('inventory_spare_parts_histories', 'Edit Spare Part In Storage ' ,   Auth::id() , $spare_part->id , 'inventory.spare_parts.edit_spare_parts_in_storage');
            return \Redirect::route('user.inventory.spare_parts.spare_parts_in_storage')->with('success', 'Data Updated Sucessfully');
        }
    ...
    public function delete_spare_parts_status(Request $request){
        ...
        // $this->history_table('customer_histories', $customer_info->action , $user_id);
        $this->history_table('inventory_spare_parts_histories', 'Delete' ,   Auth::id() , $customer_info->id , 'inventory.spare_parts.edit_spare_parts_in_storage');
    ...
    public function restore_spare_parts(Request $request){
        ...
        $this->history_table('inventory_spare_parts_histories', 'Restored' ,   Auth::id() , $customer_info->id , 'inventory.spare_parts.edit_spare_parts_in_storage');
    ...
    public function spare_parts_trash(){
        ...
        $data['view'] = 'inventory.spare_parts.deleted_data_in_storage';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function save_spare_parts_entry(Request $request){
     ...
     //    dd( (int)$request->input('part_description_id'));
        $spare_part = Inventory_spare_parts::find((int)$request->input('part_description_id'));

        if($request->input('quantity') >= $spare_part->quantity ){
            return \Redirect::route('user.inventory.spare_parts.spare_parts_entry')->with('error', 'Product you selected is low in inventory');
        }
        ...
        if($spare_part_entery->save()){
            $this->history_table('inventory_spare_parts_entery_histories', 'Sparepart Entery  Added' ,   Auth::id() , $spare_part->id , 'inventory.spare_parts.edit_spare_parts_entry');

            $spare_part->quantity = $spare_part->quantity - $spare_part_entery->quantity;
            $spare_part->save();

            $this->history_table('inventory_spare_parts_histories', $spare_part->quantity.' Sparepart given to driver' ,   Auth::id() , $spare_part->id , 'inventory.spare_parts.edit_spare_parts_in_storage');

            return \Redirect::route('user.inventory.spare_parts.spare_parts_entry')->with('success', 'Data Added Sucessfully');
        }
    ...
    public function update_spare_parts_entry(Request $request){
        ...
        if($spare_part_entery->save()){
            $this->history_table('inventory_spare_parts_entery_histories', 'Sparepart Entery  Edited' ,   Auth::id() , $spare_part_entery->id , 'inventory.spare_parts.edit_spare_parts_entry');

            return \Redirect::route('user.inventory.spare_parts.spare_parts_entry')->with('success', 'Data Updated Sucessfully');
        }
    ...
    public function delete_spare_parts_entry_status(Request $request){
        ...
        // $this->history_table('customer_histories', $customer_info->action , $user_id);
        $this->history_table('inventory_spare_parts_entery_histories', 'Delete' ,   Auth::id() , $customer_info->id , 'inventory.spare_parts.edit_spare_parts_entry');
    ...
    public function restore_spare_parts_entry(Request $request){
        ...
        $this->history_table('inventory_spare_parts_entery_histories', 'Restored' ,   Auth::id() , $customer_info->id , 'inventory.spare_parts.edit_spare_parts_entry');
    ...
    public function spare_parts_entry_trash(){
        ...
        $data['view'] = 'inventory.spare_parts.deleted_data_entry';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function tools_in_storage(){
        ...
        $data['view'] = 'inventory.tools.tools_in_storage';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function add_tools_in_storage(){
        ...
        ";
        $data['view'] = 'inventory.tools.add_tools_in_storage';
        return view('users.layout', ["data"=>$data]);
    ...
    public function edit_tools_in_storage(Request $request){
        ...
        ";
        $data['view'] = 'inventory.tools.edit_tools_in_storage';
        return view('users.layout', ["data"=>$data]);
    ...
    public function view_tools_in_storage(Request $request){
        ...
        ";
        $data['view'] = 'inventory.tools.view_tools_in_storage';
        return view('users.layout', ["data"=>$data]);
    ...
    public function update_tools_in_storage(Request $request){
        ...
        if($spare_part->save()){
            $this->history_table('inventory_tools_histories', 'Edit Spare Part In Storage ' ,   Auth::id() , $spare_part->id , 'inventory.tools.edit_tools_in_storage');
            return \Redirect::route('user.inventory.tools.tools_in_storage')->with('success', 'Data Updated Sucessfully');
        }
    ...
    public function delete_tools_status(Request $request){
        ...
        $this->history_table('inventory_tools_histories', 'Delete' ,   Auth::id() , $customer_info->id , 'inventory.tools.view_tools_in_storage');
    ...
    public function restore_tools(Request $request){
        ...
        $this->history_table('inventory_tools_histories', 'Restored' ,   Auth::id() , $customer_info->id , 'inventory.tools.view_tools_in_storage');
    ...
    public function tools_trash(){
        ...
        $data['view'] = 'inventory.tools.deleted_data_in_storage';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function tools_entry(){
        ...
        $data['view'] = 'inventory.tools.tools_entry';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function add_tools_entry(){
        ...
        $data['view'] = 'inventory.tools.add_tools_entry';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function save_tools_entry(Request $request){
        ...
        if($request->input('quantity') > $tool_in_storage->quantity ){
            return \Redirect::route('user.inventory.tools.tools_entry')->with('error', 'Product you selected is low in inventory');
        }
        ...
        if($tools_entery->save()){
            $this->history_table('inventory_tools_entry_histories', 'Tools Entery  Added' ,   Auth::id() , $tools_entery->id , 'inventory.tools.edit_tools_entry');

            $tool_in_storage->quantity = $tool_in_storage->quantity - $tools_entery->quantity;
            $tool_in_storage->save();

            $this->history_table('inventory_tools_histories', $tools_entery->quantity.' Tools given to ' .$tools_entery->assign_person_designation  ,   Auth::id() , $tool_in_storage->id , 'inventory.tools.view_tools_in_storage');

            return \Redirect::route('user.inventory.tools.tools_entry')->with('success', 'Data Added Sucessfully');
        }
    ...
    public function update_tools_entry(Request $request){
        ...
        if($tools_entery->save()){
            $this->history_table('inventory_tools_entry_histories', 'Tools Entery  Edited' ,   Auth::id() , $tools_entery->id , 'inventory.tools.edit_tools_entry');

        
            return \Redirect::route('user.inventory.tools.tools_entry')->with('success', 'Data Updated Sucessfully');
        }
    ...
    public function edit_tools_entry(Request $request){
        ...
        $data['view'] = 'inventory.tools.edit_tools_entry';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function delete_tools_entry_status(Request $request){
        ...
        // $this->history_table('customer_histories', $customer_info->action , $user_id);
        $this->history_table('inventory_tools_entry_histories', 'Delete' ,   Auth::id() , $customer_info->id , 'inventory.tools.edit_tools_entry');
    ...
    public function restore_tools_entry(Request $request){
        ...
        $this->history_table('inventory_tools_entry_histories', 'Restored' ,   Auth::id() , $customer_info->id , 'inventory.tools.edit_tools_entry');
    ...
    public function tools_entry_trash(){
        ...
        $data['view'] = 'inventory.tools.deleted_data_entry';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function uncategorized (){
        ...
        $data['view'] = 'inventory.uncategorized.uncategorized';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function view_uncategorized(Request $request){
        ...
        ";
        $data['view'] = 'inventory.uncategorized.view_uncategorized';
        return view('users.layout', ["data"=>$data]);
    ...
    public function delete_uncategorized_status(Request $request){
        ...
        $this->history_table('inventory_uncategorized_histories', 'Delete' ,   Auth::id() , $customer_info->id , 'inventory.uncategorized.view_uncategorized');
    ...
    public function uncategorized_tools(Request $request){
        ...
        $this->history_table('inventory_tools_histories', 'Restored' ,   Auth::id() , $customer_info->id , 'inventory.uncategorized.view_uncategorized');
    ...
    public function uncategorized_trash(){
        ...
        $data['view'] = 'inventory.uncategorized.deleted_data';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function vehicle (){
        ...
        $data['view'] = 'inventory.vehicle.vehicle';
        return view('users.layout', ["data"=>$data]);
    }
    ...
    public function view_vehicle(Request $request){
        ...
        $data['view'] = 'inventory.vehicle.view_vehicle';
        return view('users.layout', ["data"=>$data]);
    ...
    public function vehicle_trash(){
        ...
        $data['view'] = 'inventory.vehicle.deleted_data';
        return view('users.layout', ["data"=>$data]);
    }
}