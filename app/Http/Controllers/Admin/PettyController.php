...
class PettyController extends Controller
{
    ...
    public function finance_request(){
        ...
        $data['view'] = 'admin.petty.finance_request.finance_request';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function add_finance_request(){
        ...
        $data['view'] = 'admin.petty.finance_request.add_finance_request';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function edit_finance_request(Request $request){
        ...
        $data['view'] = 'admin.petty.finance_request.edit_finance_request';
        return view('layout', ["data"=>$data]);
    ...
    public function save_finance_request(Request $request){
        ...
        $finance_request->user_id = 0;
        $finance_request->action = 'Add';

        $finance_request->save();

        $this->history_table('petty_finance_request_histories', 'Add' , 0,  $finance_request->id , "petty.view_finance_request");

        return \Redirect::route('admin.petty.finance_request')->with('success', 'Data Added Sucessfully');
    ...
    public function update_finance_request(Request $request){
        ...
        $finance_request->save();
        $this->history_table('petty_finance_request_histories', 'Update' , 0,  $finance_request->id , "petty.view_finance_request");

        return \Redirect::route('admin.petty.finance_request')->with('success', 'Data Updated Sucessfully');
    ...
    public function delete_finance_request(Request $request){
        ...
        $this->history_table('petty_finance_request_histories', 'Delete' , 0,  $finance_request->id , "petty.view_finance_request");
    ...
    public function view_finance_request(Request $request){
        ...
        $data['view'] = 'admin.petty.finance_request.view_finance_request';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function payable_purchase(){
        ...
        $data['view'] = 'admin.petty.petty_entery.purchase_entery';
        return view('layout', ["data"=>$data]);
    }
        ...
        if($purchase != null){
            ...
            if($petty != null){
                ...
                if((float)$petty->total_amount - (float)$request->input('amount') < 0){
                    ...
                    return \Redirect::route('admin.petty.payable_purchase')->with('error', 'Not Enough Blanace');
                }
            ...
            $purchase->save();
             ...
             return \Redirect::route('admin.petty.payable_purchase')->with('success', 'Data Updated Successfully');
        }

        return \Redirect::route('admin.petty.payable_purchase')->with('error', 'Field Not Found or Deleted');
    }
    ...
    public function update_purchase_status(Request $request){
        ...
        return \Redirect::route('admin.petty.payable_purchase')->with('success', 'Reciving Updated');
    ...
    public function payable_booking(){
        ...
        $data['view'] = 'admin.petty.petty_entery.booking_entery';
        return view('layout', ["data"=>$data]);
    }
        ...
        if($purchase != null){
            ...
            if($petty != null){
                ...
                if((float)$petty->total_amount - (float)$request->input('amount') < 0){
                    ...
                    return \Redirect::route('admin.petty.payable_booking')->with('error', 'Not Enough Blanace');
                }
            ...
            $purchase->save();
             ...
             return \Redirect::route('admin.petty.payable_booking')->with('success', 'Data Updated Successfully');
        }

        return \Redirect::route('admin.petty.payable_booking')->with('error', 'Field Not Found or Deleted');
    }
    ...
    public function update_booking_status(Request $request){
        ...
        return \Redirect::route('admin.petty.payable_booking')->with('success', 'Reciving Updated');
    ...
    public function payable_hr(){
        ...
        $data['view'] = 'admin.petty.petty_entery.hr_entery';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function issue_hr_payment(Request $request){
        ...
        if($purchase != null){
            ...
            if($petty != null){
                ...
                return \Redirect::route('admin.petty.payable_hr')->with('error', 'Not Enough Blanace');
            }
            ...
            $purchase->save();
             ...
             return \Redirect::route('admin.petty.payable_hr')->with('success', 'Data Updated Successfully');
        }

        return \Redirect::route('admin.petty.payable_hr')->with('error', 'Field Not Found or Deleted');
    }
    ...
    public function update_hr_status(Request $request){
        ...
        return \Redirect::route('admin.petty.payable_hr')->with('success', 'Reciving Updated');
    ...
    public function payable_bill(){
        ...
        $data['page_title'] = "Petty Payable Hr";
        $data['view'] = 'admin.petty.petty_entery.bill_entery';
        return view('layout', ["data"=>$data]);
    }
    ...
    //     $data['page_title'] = "Petty Payable Hr";
    //     $data['view'] = 'admin.petty.petty_entery.add_bill_entery';
    //     return view('layout', ["data"=>$data]);
    // }
    ...
    public function save_payable_bill(Request $request){
        ...
        $petty = Petty::latest()->first();
            if($petty != null){
                ...
                if((float)$petty->total_amount - (float)$request->input('amount') < 0){
                    ...
                    return \Redirect::route('admin.petty.payable_bill')->with('error', 'Not Enough Blanace');
                }
        ...
        return \Redirect::route('admin.petty.payable_bill')->with('success', 'Data Added Successfully');
    ...
    public function update_bill_status(Request $request){
        ...
        return \Redirect::route('admin.petty.payable_bill')->with('success', 'Reciving Updated');
    ...
    public function petty_detail(){
        ...
        $data['view'] = 'admin.petty.petty_detail';
        return view('layout', ["data"=>$data]);
    }
}