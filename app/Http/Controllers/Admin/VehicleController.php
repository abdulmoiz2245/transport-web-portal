...
use App\Models\Vehicle_edit_history;
...
class VehicleController extends Controller
{
    ...
    public function save_vehicle(Request $request){
        ...
        // if($vehicle->action == null || $vehicle->status == 'approved' || $vehicle->action == 'nill' ){
            $vehicle->action = 'Add';
        // }
        ...
        // if($vehicle->status == 'approved' || $vehicle->user_id == 0 ){
            //  $this->history_table('customer_histories', $customer_info->action , $user_id, "route('admin.customer.view_customer')", $customer_info->id);
             $this->history_table('vehicle_histories',"Vehicle ". $vehicle->action , $user_id,  $vehicle->id, "vehicle.view_vehicle");
        // }


        return \Redirect::route('admin.vehicle.vehicle')->with('Success', 'Data Added Sucessfully');
    ...
    public function update_vehicle(Request $request){
        ...
        if($vehicle->status == 'approved' || $vehicle->user_id == 0 ){
            //  $this->history_table('vehicle_histories', $vehicle->action , $user_id);
             $this->history_table('vehicle_histories', $vehicle->action , $user_id , $vehicle->id , 'vehicle.view_vehicle');
        }


        return \Redirect::route('admin.vehicle.vehicle')->with('success', 'Data Updated Sucessfully');
    }
    ...
    public function vehicle_fleet(){
        ...
        $data['view'] = 'admin.vehicle.fleet_vehicle';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function trailer_fleet(){
        ...
        $data['view'] = 'admin.vehicle.fleet_trailer';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function assign_vehicle(){
        ...
        $data['view'] = 'admin.vehicle.assign_unassign.assign_unassign_vehicle';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function assign_vehicle_save(Request $request){
        ...
        if($assign_vehicle->save()){
            ...
            return \Redirect::route('admin.vehicle.assign_vehicle')->with('success', 'Vehicle Assigned Sucessfully');
    ...
    public function unassign_vehicle($assign_id = 0){
        ...
        return view('admin.vehicle.assign_unassign.unassign_vehicle', ["data"=>$data]); 
    }
    ...
    public function trash_assign_unassign(){
        ...
        $data['view'] = 'admin.vehicle.assign_unassign.deleted_data';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function trash_vehicle(){
        ...
        $data['view'] = 'admin.vehicle.deleted_data';
        return view('layout', ["data"=>$data]);
    }
