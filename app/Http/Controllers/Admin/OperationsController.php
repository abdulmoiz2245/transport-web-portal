...
class OperationsController extends Controller
{
    ...
    public function operations(){
        ...
        $data['view'] = 'admin.operations.operations';
    ...
    public function employee_attendence(){
        ...
        $data['view'] = 'admin.operations.attendance.attendance';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function employee_leave(){
        ...
        $data['view'] = 'admin.operations.attendance.leave.leave';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function trash_employee_leave(){
        ...
        $data['view'] = 'admin.operations.attendance.leave.deleted_data';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function add_employee_leave(){
        ...
        $data['view'] = 'admin.operations.attendance.leave.add_leave';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function view_employee_leave(Request $request){
        ...
        $data['view'] = 'admin.operations.attendance.leave.view_leave';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function edit_employee_leave (Request $request){
        ...
        $data['view'] = 'admin.operations.attendance.leave.edit_leave';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function employee_attendence_mark($date=null){
        ...
        $data['permission'] =  Permissions::where('role_id', '=', $user->role_id)->get();
            ...
            $data['view'] = 'admin.operations.attendance.mark_attendance';
            return view('layout', ["data"=>$data]);
    }
    ...
    public function employee_attendence_report(){
        ...
        $data['view'] = 'admin.operations.attendance.attendance_report';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function complaints(){
        ...
        $data['view'] = 'admin.operations.complaints.complaints';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function trash_complaints(){
        ...
        $data['view'] = 'admin.operations.complaints.deleted_data';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function add_complaints(){
        ...
        $data['view'] = 'admin.operations.complaints.add_complaints';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function view_complaints(Request $request){
        ...
        $data['view'] = 'admin.operations.complaints.view_complaints';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function edit_complaints (Request $request){
        ...
        $data['view'] = 'admin.operations.complaints.edit_complaints';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function absent(){
        ...
        $data['view'] = 'admin.operations.absent.absent';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function trash_absent(){
        ...
        $data['view'] = 'admin.operations.absent.deleted_data';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function add_absent(){
        ...
        $data['view'] = 'admin.operations.absent.add_absent';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function view_absent(Request $request){
        ...
        $data['view'] = 'admin.operations.absent.view_absent';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function edit_absent (Request $request){
        ...
        $data['view'] = 'admin.operations.absent.edit_absent';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function new_booking(){
        ...
        $data['view'] = 'admin.operations.booking.new_booking.new_booking';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function new_normal_booking(Request $request){
        ...
        $data['trailer'] = Vehicle::where('registration_type' ,'=' , 'trailer')->where('row_status' ,'=' , 'active')->where('status' ,'=' , 'approved')->get();
            ...
            // $data['page']
        $data['page_title'] = "New Booking";
        $data['view'] = 'admin.operations.booking.new_booking.new_normal_booking';
        return view('layout', ["data"=>$data]);

    }

    public function new_otj_booking(Request $request){

        $user = Auth::user();
        
        $customer = new Customer_info();
        $customer->name = $request->input('name');
        $customer->trn = $request->input('trn');
        ...
        if ($request->hasFile('business_license_copy')) {
            ...
            if($file->storeAs('/main_admin/customer/', $name , ['disk' => 'public_uploads'])){
                $customer->business_license_copy = $name;

            }
            
        }

        $customer->business_license_expiary_date = $request->input('business_license_expiary_date');
        $customer->term = $request->input('term');
        $customer->account_contact = $request->input('account_contact');
        $customer->logistic_contact = $request->input('logistic_contact');
        $customer->from = $request->input('from');
        $customer->to = $request->input('to');
        $customer->trip_rate = $request->input('trip_rate');
        $customer->ap_km = $request->input('ap_km');
        $customer->ap_fuel = $request->input('ap_fuel');
        $customer->driver_comission = $request->input('driver_comission');

        $customer->status = 'approved';
        $customer->row_status = 'active';
        $customer->type = 'temporary';

        $this->history_table('customer_histories', 'Temprary Customer Added', 0,  $customer->id, "customer.view_customer");
        $customer->save();
        ...
        $data['customer'] = Customer_info::where('id' , '=' ,$customer->id)->where('type' , '=' ,'temporary')->where('row_status' ,'=' , 'active')->where('status' ,'=' , 'approved')->first();
        // $data['customer_rate_card'] = Customer_rate_card::where('id' , '=' ,$customer_rate_card_id)->where('row_status' ,'=' , 'active')->where('status' ,'=' , 'approved')->first();
        $data['sub_contractor'] = Sub_contractor_info::where('row_status' ,'=' , 'active')->where('status' ,'=' , 'approved')->get();
        //dd($data['modules']);
        $data['vehicle'] = Vehicle::where('registration_type' ,'=' , 'vehicle')->where('trailer_id' ,'!=' , '')->where('row_status' ,'=' , 'active')->where('status' ,'=' , 'approved')->where('booking_status' ,'=' , 'not_booked')->get();
        ...
        $data['trailer'] = Vehicle::where('registration_type' ,'=' , 'trailer')->where('row_status' ,'=' , 'active')->where('status' ,'=' , 'approved')->get();
            ...
            // $data['page']
        $data['page_title'] = "New OTJ Booking";
        $data['view'] = 'admin.operations.booking.new_booking.new_normal_booking';
        return view('layout', ["data"=>$data]);
    ...
    public function save_new_booking(Request $request){
        ...
        if($booking->save() && $vehicle->save()){
            ...
            return \Redirect::route('admin.operations.manage_booking')->with('success', 'Data Added Sucessfully');
        }
    ...
    public function update_new_booking(Request $request){
        ...
        if($booking->save()){
            ...
            return \Redirect::route('admin.operations')->with('success', 'Data Added Sucessfully');
        }
    ...
    public function manage_booking(){
        ...
        $data['view'] = 'admin.operations.booking.manage_booking.manage_booking';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function booking_status_update(Request $request){
        ...
        if($booking->save()){
            ...
            $booking->user_id = $user_id;
            return \Redirect::route('admin.operations.manage_booking')->with('success', 'Status Updated Sucessfully');
        }
    ...
    public function view_booking(Request $request){
        ...
        $data['view'] = 'admin.operations.booking.view_booking';
        return view('layout', ["data"=>$data]);
    ...
    public function pending_booking(){
        ...
        $data['view'] = 'admin.operations.booking.manage_booking.pending_booking';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function rejected_booking(){
        ...
        $data['view'] = 'admin.operations.booking.manage_booking.rejected_booking';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function save_booking_document(Request $request){
        ...
        if($booking->save()){
            ...
            return \Redirect::route('admin.operations.pending_booking')->with('success', 'Booking Updated Sucessfully');
        }
    }
    ...
    public function processed_booking(){
        ...
        $data['view'] = 'admin.operations.booking.processed_booking.processed_booking';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function trash_booking(){
        ...
        $data['view'] = 'admin.operations.booking.deleted_data';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function vehicle_fleet(){
        ...
        $data['view'] = 'admin.operations.vehicle.fleet_vehicle';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function trailer_fleet(){
        ...
        $data['view'] = 'admin.operations.vehicle.fleet_trailer';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function assign_vehicle(){
        ...
        $data['view'] = 'admin.operations.vehicle.assign_unassign.assign_unassign_vehicle';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function assign_vehicle_save(Request $request){
        ...
        if($assign_vehicle->save()){
            ...
            return \Redirect::route('admin.operations.vehicle.assign_vehicle')->with('success', 'Vehicle Assigned Sucessfully');
    ...
    public function unassign_vehicle_save(Request $request){
        ...
        if( $assign_vehicle->save() &&  $vehicle->save() && $trailer->save() &&  $driver->save() && $equipment_list->save()){
            ...
            // return \Redirect::route('admin.vehicle.assign_vehicle')->with('Success', 'Data Added Sucessfully');
    ...
    public function view_assigned_unassigned_vehicle(Request $request){
        ...
        $data['view'] = 'admin.vehicle.assign_unassign.view_assign_unassign_vehicle';
        return view('layout', ["data"=>$data]);
    ...
    public function view_vehicle(Request $request){
        ...
        $data['view'] = 'admin.operations.vehicle.view_vehicle';
        return view('layout', ["data"=>$data]);
    }
