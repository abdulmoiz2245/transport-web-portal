...
class PurchaseController extends Controller
{
    ...
    public function add_vehicle_purchase(){
        ...
        $data['page_title'] = "Add Purchase";
        $data['view'] = 'admin.purchase.add_vehicle_purchase';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function view_vehicle_purchase(Request $request){
        ...
        $data['page_title'] = "PURCHASE";
        $data['view'] = 'admin.purchase.view_vehicle_purchase';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function edit_vehicle_purchase (Request $request){
        ...
        $data['page_title'] = "Edit Purchase";
        $data['view'] = 'admin.purchase.edit_vehicle_purchase';
        return view('layout', ["data"=>$data]);
    }
    ...
    public function update_vehicle_purchase(Request $request){
        ...
        if($purchase->status_admin == 'approved' || $purchase->user_id == 0 ){
            $this->history_table('purchase_vehicle_histories', $purchase->action , $user_id,  $purchase->id, "purchase.view_vehicle_purchase");
        }
    ...
    public function delete_vehicle_purchase(Request $request){
        ...
        $this->history_table('purchase_vehicle_histories', $trade_license->action , $user_id ,  $trade_license->id, "purchase.view_vehicle_purchase");
    ...
    public function delete_vehicle_purchase_status(Request $request){
        $id =  (int)$request->input('id');
        $trade_license = Purchase_vehicle::where('id' , $id)->first();
    ...
    public function restore_vehicle_purchase(Request $request){
        $id =  (int)$request->input('id');
        $trade_license = Purchase_vehicle::where('id' , $id)->first();
