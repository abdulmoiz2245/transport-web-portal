...
use App\Http\Controllers\Admin\Hr_ProController;
...
Route::group(['prefix'=>'/admin/hr-pro','as'=>'admin.hr_pro.'], function(){
    ...
    Route::post('/table-history-type/clear', [Hr_ProController::class, 'table_history_type_clear']) 
    ->name('table_history_type_clear');
