<?php
use App\Http\Controllers\Admin\PettyController ;
...
Route::get('/admin/petty-cash', [PettyController::class, 'petty']) 
->name('admin.petty');

Route::group(['prefix'=>'/admin/petty','as'=>'admin.petty.'], function(){
