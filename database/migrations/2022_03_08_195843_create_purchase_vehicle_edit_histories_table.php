...
class CreatePurchaseVehicleEditHistoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('purchase_vehicle_edit_histories', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('purchase_vehicle_edit_histories');
    }
}
