...
class CreateSubContractorInfosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sub_contractor_infos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sub_contractor_infos');
    }
}
