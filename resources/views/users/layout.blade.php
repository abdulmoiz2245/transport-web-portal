                ...
                <div class="header-part-right">
                    ...
                    <div class="dropdown">
                        <div class="user colalign-self-end">
                            ...
                            @else 
                            <img id="profile_pic" src="{{  asset('main_admin/profile') }}/1631019998_no_image.jpg" alt="no-img"  id="userDropdown" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"/>
                            @endif
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                                ...
                                <a class="dropdown-item" href="{{ route('user.dashboard') }}">Profile settings</a>
              ...
              <div class="sidebar-left open" data-perfect-scrollbar="" data-suppress-scroll-x="true">
                <ul class="navigation-left">
                    <li class="nav-item active" data-item="">
                        <a class="nav-item-hold" href="{{ route('user.dashboard') }}">
                ...
                @foreach ($data['modules'] as $module)
                    ...
                    @foreach($data['permission'] as $permissions)
                        ...
                        @if($permissions->module_id == $module->id)
                        
                        @if($permissions->operation == 'view' && $permissions->status == 1)
                        <?php $found = false; ?>
                        @foreach ($data['modules'] as $sub_module)
