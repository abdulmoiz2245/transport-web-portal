<div class="container">
    ...
    <form action="{{ route('admin.hr_pro.update_complaints') }}" method="post" enctype="multipart/form-data">
    @csrf
            ...
            <div class="col-md-6 col-12">
                <div class="form-group">
                    ...
                    <select name="status" class="form-control">
                        ...
                        <option value='approved' <?php if($data['complaint']->status == 'approved') echo 'selected="selected"' ?> >Approved</option>
                        <option value='rejected' <?php if($data['complaint']->status == 'rejected') echo 'selected="selected"' ?>>Rejected</option>
                        <option value='pending_admin' <?php if($data['complaint']->status == 'pending_admin') echo 'selected="selected"' ?>>Pending</option>
                    </select>
                </div>
            </div>
        </div>
