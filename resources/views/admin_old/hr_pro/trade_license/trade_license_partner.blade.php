...
<div class="container">
    <div class="d-flex mb-3" style="justify-content:space-between;">
        ...
        <div class=""> 
            ...
            <a href="{{ route( 'admin.hr_pro.trash_trade_license_partners') }}" class="ml-3" target="_blank">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route( 'admin.hr_pro.edit_trade_license_partners') }}" method="post" class="d-inline">
                                            @csrf
...
<script>
    ...
    function delete_fun(clicked_id) {
        ...
        swal({
            ...
            $.ajax({
                type:'POST',
                url:"{{ route( 'admin.hr_pro.delete_trade_license_partners_status') }}",
