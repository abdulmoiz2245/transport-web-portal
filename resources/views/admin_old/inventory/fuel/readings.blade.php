...
<div class="container">
    ...
    <div class="d-flex" style="justify-content: space-between;">
        ...
        <div class=""> 
            <a href="{{ route( 'admin.inventory.fuel.fuel_reading_history') }}"target="_blank" class="ml-3">
                    <img src="<?= asset('assets') ?>/images/history_icon.png" alt="" width="30">
            </a> 
            <a href="{{ route( 'admin.inventory.fuel.trash_fuel_reading') }}" class="ml-3" target="_blank">
