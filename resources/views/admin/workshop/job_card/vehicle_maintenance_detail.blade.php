...
<div class="container">
    <div class="d-flex" style="justify-content: space-between;">
        ...
        <div class=""> 
            ...
            <a href="{{ route( 'admin.workshop.trash_job_card') }}" class="ml-3" title="Trash" target="_blank">
                        ...
                        <table class="display table  nowrap  " style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr> 
                                    ...
                                    <td>
                                        <form action="{{ route( 'admin.workshop.view_job_card') }}" method="post" class="d-inline">
                                            @csrf
                                        ...
                                        <!-- <form action="{{ route( 'admin.workshop.edit_job_card') }}" method="post" class="d-inline">
                                            @csrf
                                            <input type="text" class="form-control d-none" name="id" value ="{{$workshop->id}}" placeholder="Enter id" >
                                            <button type="submit" class="border-0 bg-white">
...
<script>
    ...
    $('.delete-file').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type:'POST',
                    url:"{{ route( 'admin.workshop.delete_job_card_status') }}",
