...
<div class="container">
    <div class="d-flex" style="justify-content: space-between;">
        ...
        <div class=""> 
            <a href="{{ route( 'admin.workshop.preventive_check_list_history') }}"target="_blank" class="ml-3">
                <img src="<?= asset('assets') ?>/images/history_icon.png" alt="" title="History" width="30">
            </a>

            <a href="{{ route( 'admin.workshop.trash_preventive_check_list') }}" class="ml-3" title="Trash" target="_blank">
                        ...
                        <table class="display table  nowrap  " style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr> 
                                    ...
                                    <td>
                                        <form action="{{ route( 'admin.workshop.view_preventive_check_list') }}" method="post" class="d-inline">
                                            @csrf
                                        ...
                                        <form action="{{ route( 'admin.workshop.edit_preventive_check_list') }}" method="post" class="d-inline">
                                            @csrf
                                            <input type="text" class="form-control d-none" name="id" value ="{{$workshop->id}}" placeholder="Enter id" >
                                            <button type="submit" class="border-0 bg-white">
...
<script>
    ...
    $('.delete-file').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type:'POST',
                    url:"{{ route( 'admin.workshop.delete_preventive_check_list_status') }}",
