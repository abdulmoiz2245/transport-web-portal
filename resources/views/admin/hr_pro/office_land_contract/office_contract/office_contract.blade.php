...
<div class="tab" >
  <button  class="tablinks "> <a href="{{ route('admin.hr_pro.add_office_contracts') }}" style=""> Add Office Contract </a>  </button>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="mt-3 mb-3"> 
                ...
                <a href="{{ route( 'admin.hr_pro.trash_office_contracts') }}" target="_blank" class="ml-3">
                        ...
                        <table id="trade_license"  class="display table  nowrap " style="width:100%">
                            ...
                            <tbody>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route( 'admin.hr_pro.edit_office_contracts') }}" method="post" class="d-inline">
                                        @csrf
                                        <input type="text" class="form-control d-none" name="id" value ="{{$office_contract->id}}" placeholder="Enter id" >
                                        <button type="submit" class="border-0 .bg-white">
