        ...
        <div class="col-12">
            ...
            <ul class="nav nav-tabs mt-3 mb-5" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link" id="pending-tab" data-toggle="tab" href="#pending" role="tab" aria-controls="pending" aria-selected="false">  <b>Pending ({{  Civil_defense_documents::where('status', '=', 'pending')->where('type', '=', 'mobile')->count() }})</b> </a>
                </li>
                <li class="nav-item">
                    ...
                    <a class="nav-link" id="rejected-tab" data-toggle="tab" href="#rejected" role="tab" aria-controls="rejected" aria-selected="false">  <b>Rejected ({{  
                        Civil_defense_documents::where('status', '=', 'rejected')->where('type', '=', 'mobile')->count() }})</b> </a>
                </li>
            </ul>
