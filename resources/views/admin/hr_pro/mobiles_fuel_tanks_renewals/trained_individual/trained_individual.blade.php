...
<div class="tab" >
  <button  class="tablinks "> <a href="{{ route('admin.hr_pro.add_mobiles_trained_individual') }}" style=""> Add Trained Individual </a>  </button>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="mt-3 mb-3"> 
                ...
                <a href="{{ route( 'admin.hr_pro.mobile_trained_individual_history') }}"target="_blank" class="ml-3">
                        <img src="<?= asset('assets') ?>/images/history_icon.png" alt="" width="30">
                </a> 

                <a href="{{ route( 'admin.hr_pro.trash_mobiles_trained_individual') }}" target="_blank" class="ml-3">
                        ...
                        <table id="trade_license" class="display table  nowrap  " style="width:100%">
                            ...
                            <tbody>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route( 'admin.hr_pro.edit_mobiles_trained_individual') }}" method="post" class="d-inline">
                                        @csrf
                                        <input type="text" class="form-control d-none" name="id" value ="{{$trained_individual->id}}" placeholder="Enter id" >
                                        <button type="submit" class="border-0 .bg-white">
