...
<div class="tab" >
  <button  class="tablinks "> <a href="{{ route('admin.hr_pro.add_mobile_muncipality') }}" style=""> Add Muncipality </a>  </button>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="mt-3 mb-3"> 
                ...
                <a href="{{ route( 'admin.hr_pro.trash_mobile_muncipality') }}" target="_blank" class="ml-3">
