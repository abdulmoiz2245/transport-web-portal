<div class="container">
    ...
    <form action="{{ route('admin.hr_pro.update_non_mobile_civil_defence') }}" method="post" enctype="multipart/form-data">
    @csrf
        <div class="row">
                ...
                <div class="d-flex">
                    ...
                    @if($data['civil_defense_edit'] != null && $data['civil_defense']->document != $data['civil_defense_edit']->document )
                        ...
                        <div class="old-value"> Old file : 
                            <a target="_blank" href="{{ asset('main_admin/hr_pro/non_mobile_fuel_tank_renewals/')}}/{{$data['civil_defense_edit']->document}}" >
