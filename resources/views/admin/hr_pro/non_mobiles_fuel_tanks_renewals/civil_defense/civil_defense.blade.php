...
<div class="tab" >
  <button  class="tablinks "> <a href="{{ route('admin.hr_pro.add_non_mobile_civil_defence') }}" style=""> Add Civil Defence </a>  </button>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="mt-3 mb-3"> 
                ...
                <a href="{{ route( 'admin.hr_pro.trash_non_mobile_civil_defence') }}" target="_blank" class="ml-3">
