...
?>
<div class="container">
    <a href="{{ route( 'admin.hr_pro.add_non_mobile_muncipality') }}" class="mb-5">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route( 'admin.hr_pro.edit_non_mobile_muncipality') }}" method="post" class="d-inline">
                                            @csrf
                                            <input type="text" class="form-control d-none" name="id" value ="{{$muncipality->id}}" placeholder="Enter id" >
                                            <button type="submit" class="border-0 .bg-white">
                                        ...
                                        <a href="{{ route( 'admin.hr_pro.non_mobile_muncipality_history') }}"target="_blank" >
