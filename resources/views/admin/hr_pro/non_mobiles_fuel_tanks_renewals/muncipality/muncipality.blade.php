...
<div class="tab" >
  <button  class="tablinks "> <a href="{{ route('admin.hr_pro.add_non_mobile_muncipality') }}" style=""> Add Muncipality </a>  </button>
  <form action="" method="get">
    ...
    <button type="submit" class="tablinks <?php 
      ...
      ?>" onclick="openCity(event, 'approved')"> Approved / Existing Muncipality 
    </button>
  </form>
  <form action="" method="get">
    ...
    <button type="submit" class="tablinks <?php 
      ...
      ?>" onclick="openCity(event, 'pending')">  Pending Muncipality 
    </button>
  </form>
  <form action="" method="get">
    ...
    <button type="submit" class="tablinks <?php 
      ...
      ?>" onclick="openCity(event, 'rejected')"> Rejected Muncipality 
    </button>
  </form>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="mt-3 mb-3"> 
                ...
                <a href="{{ route( 'admin.hr_pro.trash_non_mobile_muncipality') }}" target="_blank" class="ml-3">
