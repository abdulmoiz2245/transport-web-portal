...
<div class="tab" >
  <button  class="tablinks "> <a href="{{ route('admin.hr_pro.add_non_mobile_trained_individual') }}" style=""> Add Trained Individual </a>  </button>
    ...
    <div class="card-body">
        <div class="d-flex mt-3 mb-3" style="justify-content: space-between;">
            ...
            <div class="mt-3 mb-3"> 
                ...
                <a href="{{ route( 'admin.hr_pro.trash_non_mobiles_trained_individual') }}" target="_blank" class="ml-3">
