<div class="container">
    <form action="{{ route('admin.hr_pro.update_non_mobile_trained_individual') }}" method="post" enctype="multipart/form-data">
    @csrf
            ...
            <div class="col-md-6 col-12">
                <div class="form-group">
                    ...
                    <select name="status" class="form-control">
                        <option value='pending' <?php if($data['trained_individual']->status == 'pending') echo 'selected="selected"' ?> >Pending</option>
                        <option value='approved' <?php if($data['trained_individual']->status == 'approved') echo 'selected="selected"' ?> >Approved</option>
                        <option value='rejected' <?php if($data['trained_individual']->status == 'rejected') echo 'selected="selected"' ?>>Rejected</option>
                    </select>
                </div>
            </div>
        </div>
