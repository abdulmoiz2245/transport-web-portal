...
<div class="tab" >
  <button  class="tablinks  "> <a href="{{ route('admin.hr_pro.add_employee_termination') }}" style=""> Add New </a>  </button>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="mt-3 mb-3"> 
                ...
                <a href="{{ route( 'admin.hr_pro.employee_termination_history') }}"target="_blank" class="ml-3">
                        <img src="<?= asset('assets') ?>/images/history_icon.png" alt="" width="30">
                </a> 

                <a href="{{ route( 'admin.hr_pro.trash_employee_termination') }}" target="_blank" class="ml-3">
          ...
          <div class="table-responsive">
            <table id="trade_license"  class="display table  nowrap " style="width:100%">
                ...
                <tbody>
                    ...
                    <td>
                      <form action="{{ route( 'admin.hr_pro.view_employee_termination') }}" method="post" class="d-inline">
                            @csrf
            ...
            <table id="trade_license"  class="display table  nowrap " style="width:100%">
                ...
                @foreach($data['terminate_employee'] as $terminate_employee)
                    ...
                    <td>
                        ...
                        <form action="{{ route( 'admin.hr_pro.edit_employee_termination') }}" method="post" class="d-inline">
                            @csrf
                            <input type="text" class="form-control d-none" name="id" value ="{{$terminate_employee->id}}" placeholder="Enter id" >
                            <button type="submit" class="border-0 .bg-white">
...
$('.delete-file').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type:'POST',
                    url:"{{ route( 'admin.hr_pro.delete_employee_termination_status') }}",
