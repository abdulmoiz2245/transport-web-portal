...
<div class="tab" >
  <button  class="tablinks "> <a href="{{ route('admin.hr_pro.add_employee_renewals') }}" style=""> Add New </a>  </button>
  <button class="tablinks active" onclick="openCity(event, 'terminated')"> Renewed </button>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="mt-3 mb-3"> 
                ...
                <a href="{{ route( 'admin.hr_pro.employee_renewals_history') }}"target="_blank" class="ml-3">
                        <img src="<?= asset('assets') ?>/images/history_icon.png" alt="" width="30">
                </a> 

                <a href="{{ route( 'admin.hr_pro.trash_employee_renewals') }}" target="_blank" class="ml-3">
          ...
          <div class="table-responsive">
            <table id="trade_license"  class="display table  nowrap " style="width:100%">
                ...
                <tbody>
                    ...
                    @if($renew_employee->status == 'approved'  && $renew_employee->row_status != 'deleted')
                    ...
                    <td>
                      <form action="{{ route( 'admin.hr_pro.view_employee_renewals') }}" method="post" class="d-inline">
                            @csrf
                        ...
                        <a href="#" id="{{ $renew_employee->id }}" class="delete-file">
        ...
        <div id="pending" class="tabcontent" >
          <div class="table-responsive">
            <table id="trade_license"  class="display table  nowrap " style="width:100%">
                ...
                <tbody>
                @foreach($data['renew_employee'] as $renew_employee)
                    @if($renew_employee->status == 'pending'  && $renew_employee->row_status != 'deleted')
                    @foreach($data['employees'] as $employees)
                    @if($employees->id ==  $renew_employee->emp_id)
                    ...
                    <td>
                        ...
                        <form action="{{ route( 'admin.hr_pro.edit_employee_renewals') }}" method="post" class="d-inline">
                            @csrf
                            <input type="text" class="form-control d-none" name="id" value ="{{$renew_employee->id}}" placeholder="Enter id" >
                            <button type="submit" class="border-0 .bg-white">
        ...
        <div id="rejected" class="tabcontent" >
          <div class="table-responsive">
            <table id="trade_license"  class="display table  nowrap " style="width:100%">
                ...
                <tbody>
                    @foreach($data['renew_employee'] as $renew_employee)
                    @if($renew_employee->status == 'rejected'  && $renew_employee->row_status != 'deleted')
                    @foreach($data['employees'] as $employees)
                    @if($employees->id ==  $renew_employee->emp_id)
...
$('.delete-file').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type:'POST',
                    url:"{{ route( 'admin.hr_pro.delete_employee_renewals_status') }}",
