...
<div class="tab" >
  <button  class="tablinks "> <a href="{{ route('admin.hr_pro.add_employee_deduction') }}" style=""> Add New </a>  </button>
  <button class="tablinks active" onclick="openCity(event, 'terminated')"> Deduction </button>
</div>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="mt-3 mb-3"> 
                ...
                <a href="{{ route( 'admin.hr_pro.employee_deduction_history') }}"target="_blank" class="ml-3">
                        <img src="<?= asset('assets') ?>/images/history_icon.png" alt="" width="30">
                </a> 

                <a href="{{ route( 'admin.hr_pro.trash_employee_deduction') }}" target="_blank" class="ml-3">
          ...
          <div class="table-responsive">
            <table id="trade_license"  class="display table  nowrap " style="width:100%">
                ...
                <tbody>
                    ...
                    <td>
                      <form action="{{ route( 'admin.hr_pro.view_employee_deduction') }}" method="post" class="d-inline">
                            @csrf
                            <input type="text" class="form-control d-none" name="id" value ="{{$employee_deduction->id}}" placeholder="Enter id" >
                            <button type="submit" class="border-0 .bg-white">
                                <img src="<?= asset('assets') ?>/images/eye_icon.png" alt="" width="34">
                            </button>
                        </form>
                        <a href="#" id="{{ $employee_deduction->id }}" class="delete-file">
        ...
        <div id="pending" class="tabcontent" >
          <div class="table-responsive">
            <table id="trade_license"  class="display table  nowrap " style="width:100%">
                ...
                <tbody>
                @foreach($data['employee_deduction'] as $employee_deduction)
                    @if($employee_deduction->status == 'pending'  && $employee_deduction->row_status != 'deleted')
                    @foreach($data['employees'] as $employees)
                    @if($employees->id ==  $employee_deduction->emp_id)
                    ...
                    <td>
                        ...
                        <form action="{{ route( 'admin.hr_pro.edit_employee_deduction') }}" method="post" class="d-inline">
                            @csrf
                            <input type="text" class="form-control d-none" name="id" value ="{{$employee_deduction->id}}" placeholder="Enter id" >
                            <button type="submit" class="border-0 .bg-white">
        ...
        <div id="rejected" class="tabcontent" >
          <div class="table-responsive">
            <table id="trade_license"  class="display table  nowrap " style="width:100%">
                ...
                <tbody>
                    @foreach($data['employee_deduction'] as $employee_deduction)
                    @if($employee_deduction->status == 'rejected'  && $employee_deduction->row_status != 'deleted')
                    @foreach($data['employees'] as $employees)
                    @if($employees->id ==  $employee_deduction->emp_id)
...
$('.delete-file').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type:'POST',
                    url:"{{ route( 'admin.hr_pro.delete_employee_deduction_status') }}",
