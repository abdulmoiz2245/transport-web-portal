...
<div class="tab" >
  <button  class="tablinks "> <a href="{{ route('admin.hr_pro.add_employee_suspension') }}" style=""> Add New </a>  </button>
  <button class="tablinks active" onclick="openCity(event, 'terminated')"> Suspended </button>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="mt-3 mb-3"> 
                ...
                <a href="{{ route( 'admin.hr_pro.employee_suspension_history') }}"target="_blank" class="ml-3">
                        <img src="<?= asset('assets') ?>/images/history_icon.png" alt="" width="30">
                </a> 

                <a href="{{ route( 'admin.hr_pro.trash_employee_suspension') }}" target="_blank" class="ml-3">
          ...
          <div class="table-responsive">
            <table id="trade_license"  class="display table  nowrap " style="width:100%">
                ...
                <tbody>
                    ...
                    @if($employee_suspension->status == 'approved'  && $employee_suspension->row_status != 'deleted')
                    ...
                    <td>
                      <form action="{{ route( 'admin.hr_pro.view_employee_suspension') }}" method="post" class="d-inline">
                            @csrf
                        ...
                        <a href="#" id="{{ $employee_suspension->id }}" class="delete-file">
        ...
        <div id="pending" class="tabcontent" >
          <div class="table-responsive">
            <table id="trade_license"  class="display table  nowrap " style="width:100%">
                ...
                <tbody>
                @foreach($data['employee_suspension'] as $employee_suspension)
                    @if($employee_suspension->status == 'pending'  && $employee_suspension->row_status != 'deleted')
                    @foreach($data['employees'] as $employees)
                    @if($employees->id ==  $employee_suspension->emp_id)
                    ...
                    <td>
                        ...
                        <form action="{{ route( 'admin.hr_pro.edit_employee_suspension') }}" method="post" class="d-inline">
                            @csrf
                            <input type="text" class="form-control d-none" name="id" value ="{{$employee_suspension->id}}" placeholder="Enter id" >
                            <button type="submit" class="border-0 .bg-white">
        ...
        <div id="rejected" class="tabcontent" >
          <div class="table-responsive">
            <table id="trade_license"  class="display table  nowrap " style="width:100%">
                ...
                <tbody>
                    @foreach($data['employee_suspension'] as $employee_suspension)
                    @if($employee_suspension->status == 'rejected'  && $employee_suspension->row_status != 'deleted')
                    @foreach($data['employees'] as $employees)
                    @if($employees->id ==  $employee_suspension->emp_id)
...
$('.delete-file').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type:'POST',
                    url:"{{ route( 'admin.hr_pro.delete_employee_suspension_status') }}",
