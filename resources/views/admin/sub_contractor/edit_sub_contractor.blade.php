                ...
                <form action="" method="post" id="customer_dep">
                    ...
                    <div class="row">
                        <div class=" col-md-6 col-12 mb-3">
                            ...
                            <input type="text" name="accountant_name" value="{{ $data['customer_department']->accountant_name}}" class="form-control" required>
                        </div>
                        ...
                        <div class="col-md-6 col-12 mb-3">
                            <div class=" col-md-6 col-12 mb-3">
                                ...
                                <select name="customer_id" class="form-control customer" required>
                                    ...
                                    <option value="{{ $customer->id }}" <?php if($data['customer_info']->customer_id == $customer->id) echo 'selected="selected"' ?> >{{ $customer->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
