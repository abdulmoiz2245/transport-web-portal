...
<div class="tab" >
  ...
  <a href="{{ route('admin.petty.payable_purchase') }}">
    <button class="tablinks " onclick="openCity(event, 'approved')"> Purchase </button>
  </a>
  
  

  <a  href="{{ route('admin.petty.payable_hr') }}">
    <button class="tablinks " >Hr Funds</button>
  </a>
  <a  href="{{ route('admin.petty.payable_booking') }}">
    <button class="tablinks active " >Booking</button>
  </a>
  <a href="{{ route('admin.petty.payable_bill') }}">
    ...
    <table id="filterTable"  class="display table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><span class="badge badge-pill ">{{ $booking->job_d }}</span></td>
                ...
                <td><span class="badge badge-pill badge-warning">{{ $booking->date }}</span></td>
                <td><span class="badge badge-pill badge-warning">{{ $booking->reciving_date }}</span></td>
                <td>
                  @if( $booking->reciving == null)
                      
                      <p>No File Found</p>
                  @else
                      <a target="_blank" href="{{ asset('main_admin/petty/')}}/{{$booking->reciving}}">
                          <button class="btn">
                              View Document
                          </button>
                      </a>
                ...
                <td>
                  @if(  $booking->amount_paid > 0 &&  $booking->reciving_date == '' )
                    <button type="submit" id="{{ $booking->id }}" class="btn btn-success edit_status" data-toggle="modal" data-target="#status">
                        Upload Reciving
                    </button>
                  @endif
                </td>
...
<div class="modal fade  " id="exampleModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{ route('admin.petty.issue_booking_payment') }}" enctype="multipart/form-data" method="post">
          @csrf
...
<div class="modal fade  " id="status" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{ route('admin.petty.update_booking_status') }}" enctype="multipart/form-data" method="post">
          @csrf
      <div class="modal-body">
