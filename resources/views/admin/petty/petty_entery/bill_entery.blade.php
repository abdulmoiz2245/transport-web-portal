...
<div class="tab" >
    <button  class="tablinks " class="btn btn-success edit_cheque" data-toggle="modal" data-target="#exampleModal"> <a href="#" style=""> Add New Bill </a>  </button>
  ...
  <a  href="{{ route('admin.petty.payable_booking') }}">
    <button class="tablinks " >Booking</button>
  </a>
    ...
    <table id="filterTable"  class="display table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><span class="badge badge-pill ">{{ $purchase->bill_name }}</span></td>
                <td><span class="badge badge-pill ">{{ $purchase->description }}</span></td>
                <td>
                  @if( $purchase->upload == null)
                      
                      <p>No File Found</p>
                  @else
                      <a target="_blank" href="{{ asset('main_admin/petty/')}}/{{$purchase->upload}}">
                          <button class="btn">
                              View Document
                          </button>
                      </a>
                ...
                <td><span class="badge badge-pill ">{{ $purchase->amount }}</span></td>
...
<div class="modal fade  " id="exampleModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{ route('admin.petty.save_payable_bill') }}" enctype="multipart/form-data" method="post">
          @csrf
...
<div class="modal fade  " id="status" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{ route('admin.petty.update_bill_status') }}" enctype="multipart/form-data" method="post">
          @csrf
      <div class="modal-body">
