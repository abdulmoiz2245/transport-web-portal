...
<div class="container">
    <div class="d-flex" style="justify-content: space-between;">
        <div>
            ...
            <a href="{{ route( 'admin.inventory.tools.add_tools_entry') }}" class="ml-3">
                <img src="<?= asset('assets') ?>/images/add-button.png" alt="" title="Add Spare Parts Entry" width="30">
            </a>
        </div>

        <div class=""> 
            <a href="{{ route( 'admin.inventory.tools.tools_entry_history') }}"target="_blank" class="ml-3">
                <img src="<?= asset('assets') ?>/images/history_icon.png" alt="" title="History" width="30">
            </a>
            <a href="{{ route( 'admin.inventory.tools.tools_entry_trash') }}" class="ml-3" title="Trash" target="_blank">
                            ...
                            <tbody>
                                ...
                                <tr> 
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route( 'admin.inventory.tools.edit_tools_entry') }}" method="post" class="d-inline">
                                            @csrf
...
<script>
    ...
    $('.delete-file').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type:'POST',
                    url:"{{ route( 'admin.inventory.tools.delete_tools_entry_status') }}",
