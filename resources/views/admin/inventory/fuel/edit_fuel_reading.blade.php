<div class="container mt-3">
    ...
    <form action="{{ route( 'admin.inventory.fuel.readings.update_fuel_reading') }}" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
        @csrf
        <input type="text" name="id" class="form-control d-none" id="" value="{{$data['fuel_enterd']->id }}">
        <div class="row">
            <div class="form-group col-lg-12 col-md-6 col-12">
                <label for="reading-date">Reading Date</label>
                <input type="date" name="reading_date" class="form-control" id="reading_date" value="{{$data['fuel_enterd']->date }}">
            ...
            <div class="form-group col-md-6 col-12 non_mobile_1_reading_group">
                ...
                <span class="badge badge-pill badge-warning" style="
                    margin-left: 10px;
                ">Previous Value : {{ $data['pre_fuel_enterd']->non_mobile_1_reading }} </span>
                <input type="number" name="non_mobile_1_reading" class="form-control non_mobile_1_reading" value="{{$data['fuel_enterd']->non_mobile_1_reading }}">
            </div>
            <div class="form-group col-md-2 col-12"> 
                
                <label for="admin-status">Refill From</label>
                ...
                <select name="non_mobile_1_refill_from" id="" class="form-control non_mobile_1_refill_from">
                    <option value="0" <?php if($data['fuel_enterd']->non_mobile_1_refill_from == 0){ ?> selected="selected" <?php } ?>>Direct</option>
                    <option value="2" <?php if($data['fuel_enterd']->non_mobile_1_refill_from == 2){ ?> selected="selected" <?php } ?>>From Tank 2</option>

                </select>
            </div>
            <div class="form-group col-md-4 col-12 non_mobile_1_refill_amount_group">
                <label for="admin-status">Refill Amount</label>
                <input type="number" name="non_mobile_1_refill_amount" class="form-control non_mobile_1_refill_amount"  value="{{$data['fuel_enterd']->non_mobile_1_refill_amount }}">
            ...
            <div class=" col-md-6 col-12 mb-3">
                ...
                <select name="inter_tank_transfer_from" id="transfer" class="form-control" >
                        <option value="0" <?php if($data['fuel_enterd']->inter_tank_transfer_from == 0){ ?> selected="selected" <?php } ?>>No Transfer</option>
                        <option value="2" <?php if($data['fuel_enterd']->inter_tank_transfer_from == 1){ ?> selected="selected" <?php } ?>>Transfer From Non Mobile Tank 2 to Tank 1</option>
                </select>
            </div>
            <div class="transfer_amount form-group col-md-6 col-12 inte_transfer_amount_group">
                <label for="admin-status">Transfer Amount</label> <span class="badge badge-pill badge-warning" style="
                    margin-left: 10px;
                ">Previous Value : {{ $data['pre_fuel_enterd']->inter_tank_transfer_amount }} </span>
                <input type="number" id="inte_transfer_amount"  name="inter_tank_transfer_amount" class="form-control inte_transfer_amount" value="{{$data['fuel_enterd']->inter_tank_transfer_amount }}" >
            </div>
            <div class="col-12">
                <hr>
            ...
            <div class="form-group col-md-6 col-12 non_mobile_2_reading_group">
                ...
                <span class="badge badge-pill badge-warning" style="
                    margin-left: 10px;
                ">Previous Value : {{ $data['pre_fuel_enterd']->non_mobile_2_reading }} </span>
                <input type="number" name="non_mobile_2_reading" class="form-control non_mobile_2_reading" value="{{$data['fuel_enterd']->non_mobile_2_reading }}">
            </div>
            <div class="form-group col-md-6 col-12">
                <label for="admin-status">Refill Amount</label>
                <input type="number" name="non_mobile_2_refill_amount" class="form-control" value="{{$data['fuel_enterd']->non_mobile_2_refill_amount }}">
            </div>
            <div class="col-12">
                <hr>
            ...
            <div class="form-group col-md-6 col-12 mobile_1_reading_group">
                ...
                <span class="badge badge-pill badge-warning" style="
                    margin-left: 10px;
                ">Previous Value : {{ $data['pre_fuel_enterd']->mobile_1_reading }} </span>
                <input type="number" name="mobile_1_reading" class="form-control mobile_1_reading" value="{{$data['fuel_enterd']->mobile_1_reading }}">
            </div>
            <div class="form-group col-md-6 col-12">
                <label for="admin-status">Refill Amount</label>
                <input type="number" name="mobile_1_refill_amount" class="form-control" value="{{$data['fuel_enterd']->mobile_1_refill_amount }}" >
            </div>
            <div class="col-12">
                <hr>
            ...
            <div class="form-group col-md-6 col-12 mobile_2_reading_group">
                ...
                <span class="badge badge-pill badge-warning" style="
                    margin-left: 10px;
                ">Previous Value : {{ $data['pre_fuel_enterd']->mobile_2_reading }} </span>
                <input type="number" name="mobile_2_reading" class="form-control mobile_2_reading" value="{{$data['fuel_enterd']->mobile_2_reading }}" >
            </div>
            <div class="form-group col-md-6 col-12">
                <label for="admin-status">Refill Amount</label>
                <input type="number" name="mobile_2_refill_amount" class="form-control" value="{{$data['fuel_enterd']->mobile_2_refill_amount }}" >
            </div>
            <div class="col-12">
                <hr>
            </div>
            <div class="form-group col-md-6 col-12 fuel_entery_non_mobile_group">
                <label for="admin-status">Fuel Entry From Non Mobile</label>
                <input type="number" name="fuel_entery_non_mobile" class="form-control fuel_entery_non_mobile" value="{{$data['fuel_enterd']->fuel_entery_non_mobile }}" required>
            </div>

            <div class="form-group col-md-6 col-12 fuel_entery_mobile_group">
                <label for="admin-status">Fuel Entry From  Mobile</label>
                <input type="number" name="fuel_entery_mobile" class="form-control fuel_entery_mobile"  value="{{$data['fuel_enterd']->fuel_entery_mobile }}" required>
            </div>

            <div class="form-group col-md-6 col-12">
                <label for="admin-status">Vehicle Fuel Consumption </label>
...
<script>
    ...
    $('#reading_date').on('input', function()
    {
        ...
        var url = '{{ route("admin.inventory.fuel.readings.validate_reading_date", ":date") }}';
    ...
    {
        var previous_reading =<?= (int)$data['pre_fuel_enterd']->non_mobile_1_reading ?>;
    ...
    {
        var previous_reading =<?= (int)$data['pre_fuel_enterd']->non_mobile_2_reading ?>;
        if(this.value < previous_reading){
            var error = '<div id="validationServerUsernameFeedback" class="invalid-tooltip">Value must be equal or grater then previous value </div>';
    ...
    {
        var previous_reading =<?= (int)$data['pre_fuel_enterd']->mobile_1_reading ?>;
        if(this.value < previous_reading){
            var error = '<div id="validationServerUsernameFeedback" class="invalid-tooltip">Value must be equal or grater then previous value </div>';
    ...
    {
        var previous_reading =<?= (int)$data['pre_fuel_enterd']->mobile_2_reading ?>;
        if(this.value < previous_reading){
            var error = '<div id="validationServerUsernameFeedback" class="invalid-tooltip">Value must be equal or grater then previous value </div>';
    ...
    {
        var previous_reading =<?= (int)$data['pre_fuel_enterd']->inter_tank_transfer_amount ?>;
        if(this.value < previous_reading){
            var error = '<div id="validationServerUsernameFeedback" class="invalid-tooltip">Value must be equal or grater then previous value </div>';
