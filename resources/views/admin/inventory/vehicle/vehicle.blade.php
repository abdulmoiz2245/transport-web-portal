...
<div class="container">
    <div class="d-flex" style="justify-content: space-between;">
        ...
        <div class=""> 
            <a href="{{ route( 'admin.inventory.vehicle.vehicle_history') }}"target="_blank" class="ml-3">
                <img src="<?= asset('assets') ?>/images/history_icon.png" alt="" title="History" width="30">
            </a>

            <a href="{{ route( 'admin.inventory.vehicle.vehicle_trash') }}" class="ml-3" title="Trash" target="_blank">
                        ...
                        <table class="display table  nowrap  " style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr> 
                                    ...
                                    <td>{{ $vehicle->color }}</td>
                                    <td>
                                        <form action="{{ route( 'admin.inventory.vehicle.view_vehicle') }}" method="post" class="d-inline">
                                            @csrf
...
<script>
    ...
    $('.delete-file').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type:'POST',
                    url:"{{ route( 'admin.inventory.vehicle.delete_vehicle_status') }}",
