...
<div class="tab" >
  <button  class="tablinks "> <a href="{{ route('admin.customer.add_customer') }}" style=""> Add Customer </a>  </button>
  <form action="" method="get">
    ...
    <button type="submit" class="tablinks <?php 
      ...
      ?>" onclick="openCity(event, 'approved')"> Approved / Existing Customers 
    </button>
  </form>
  <form action="" method="get">
    ...
    <button type="submit" class="tablinks <?php 
      ...
      ?>" onclick="openCity(event, 'pending')">  Pending Customers
    </button>
  </form>
  <form action="" method="get">
    ...
    <button type="submit" class="tablinks <?php 
      ...
      ?>" onclick="openCity(event, 'rejected')"> Rejected Customers 
    </button>
  </form>
</div>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="mt-3 mb-3"> 
                ...
                <a href="{{ route( 'admin.customer.trash_customer') }}" target="_blank" class="ml-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 33px, 0px); top: 0px; left: 0px; will-change: transform;">
                                            ...
                                            <a class="dropdown-item" href="{{ route('admin.customer.customer_rate_card', $customer_info->id ) }}">View Rate Card</a>
                                        </div>
