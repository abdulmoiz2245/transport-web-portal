  ...
  <div class="tab col-md-10 col-12" >
    <form action="" method="get">
      ...
      <button type="submit" class="tablinks <?php 
        ...
        ?>" onclick="openCity(event, 'approved')"> Existing Fleet (Vehicle)
      </button>
    </form>
    <form action="" method="get">
      ...
      <button type="submit" class="tablinks <?php 
        ...
        ?>" onclick="openCity(event, 'pending')">  Pending Fleet (Vehicle)
      </button>
    </form>
    ...
    <form action="" method="get">
      ...
      <button type="submit" class="tablinks <?php 
        ...
        ?>" onclick="openCity(event, 'rejected')"> Rejected Fleet (Vehicle) 
      </button>
    </form>
  </div>
  <div class="col-md-2 col-12 tab">
    <a href="{{ route( 'admin.vehicle.trailer_fleet') }}">
...
<div class="card">
    <div class="card-body">
        ...
        <div class="mt-3 mb-3"> 
                ...
                <a href="{{ route( 'admin.vehicle.vehicle_history') }}"target="_blank" class="ml-3">
                        <img src="<?= asset('assets') ?>/images/history_icon.png" alt="" width="30">
                </a> 

                <a href="{{ route( 'admin.vehicle.trash_vehicle') }}" target="_blank" class="ml-3">
              ...
              <table class="display table nowrap  " style="width:100%">
                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          <td>{{ ucwords($vehicle_info->vehicle_type)  }}</td>
                          ...
                          <td>{{ $vehicle_info->engine_number }}</td>
                          <td>
                          ...
                          <td>
                              <form action="{{ route( 'admin.vehicle.view_vehicle') }}" method="post" class="d-inline">
                                  @csrf
                              ...
                              <form action="{{ route( 'admin.vehicle.edit_own_new_vehicle') }}" method="post" class="d-inline">
                                  @csrf
                                  <input type="text" class="form-control d-none" name="id" value ="{{$vehicle_info->id}}" placeholder="Enter id" >
                                  <button type="submit" class="border-0 bg-white">
        ...
        <div id="pending" class="tabcontent" style="display: <?php 
          ...
          <div class="table-responsive ">
            <table class="display table nowrap  " style="width:100%">
                ...
                <tbody>
                    @foreach($data['vehicle_info'] as $vehicle_info)
                    @if($vehicle_info->status == 'pending' && $vehicle_info->row_status != 'deleted')
                    <tr>
                        <td>{{ $vehicle_info->id }}</td>
                        ...
                        <td><span class="badge badge-pill badge-warning">{{ $vehicle_info->action }}</span></td>
                        <td><span class="badge badge-pill badge-warning">{{ $vehicle_info->updated_at }}</span></td>
        ...
        <div id="rejected" class="tabcontent" style="display: <?php 
          ...
          <div class="table-responsive">
            <table class="display table nowrap  " style="width:100%">
                ...
                <tbody>
                    @foreach($data['vehicle_info'] as $vehicle_info)
                    @if($vehicle_info->status == 'rejected' && $vehicle_info->row_status != 'deleted')
                    <tr>
                        <td>{{ $vehicle_info->id }}</td>
                        <td>{{ $vehicle_info->vehicle_type }}</td>
                        <td>{{ $vehicle_info->vehicle_number }}</td>
...
<script>
    ...
    $('.delete-file').click(function () {
        ...
        swal({
            ...
            $.ajax({
                type:'POST',
                url:"{{ route( 'admin.vehicle.delete_vehicle_status') }}",
