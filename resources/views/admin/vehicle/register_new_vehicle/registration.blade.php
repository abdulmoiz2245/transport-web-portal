...
<div class="container">
    ...
    <div class="d-flex" style="justify-content: space-between;">
        <div>
            ...
            <a href="{{ route( 'admin.vehicle.register_new_vehicle.add_registration') }}" class="ml-3">
                            ...
                            <table  class="display table table2  nowrap " style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route( 'admin.vehicle.register_new_vehicle.view_registration') }}" method="post" class="d-inline">
                                                @csrf
                                            ...
                                            <form action="{{ route( 'admin.vehicle.register_new_vehicle.edit_registration') }}" method="post" class="d-inline">
                                                @csrf
