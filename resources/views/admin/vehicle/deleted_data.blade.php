          ...
          <div class="table-responsive">
              <table class="display table nowrap  " style="width:100%">
                  ...
                  <tbody>
                      ...
                      @if($vehicle_info->row_status == 'deleted')
                      <tr>
                          <td>{{ $vehicle_info->id }}</td>
                          <td>{{ ucwords($vehicle_info->registration_type)  }}</td>
                          ...
                          <td>
                              ...
                              <a href="#" id="{{ $vehicle_info->id }}"  class="restore-file"  >
...
<script>
    ...
    $('.restore-file').click(function () {
        ...
        swal({
            ...
            $.ajax({
                type:'POST',
                url:"{{ route( 'admin.vehicle.restore_vehicle') }}",
