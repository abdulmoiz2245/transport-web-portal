        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <a href="{{ route('admin.operations.new_booking') }}">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <a href="{{ route('admin.operations.pending_booking') }}">
                        <div class="card card-icon mb-4">
                            <div class="card-body text-center">
                                <!-- <img src="<?= asset('assets') ?>/images/fuel.png" class="mb-1" alt="" width="35"> -->
                                <i class="nav-icon  i-Calendar-4" style="
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <a href="{{ route('admin.operations.rejected_booking') }}">
                        <div class="card card-icon mb-4">
                            <div class="card-body text-center">
                                <!-- <img src="<?= asset('assets') ?>/images/fuel.png" class="mb-1" alt="" width="35"> -->
                                <i class="nav-icon  i-Calendar-4" style="
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <a href="{{ route('admin.operations.processed_booking') }}">
                        <div class="card card-icon mb-4">
                            <div class="card-body text-center">
                                <!-- <img src="<?= asset('assets') ?>/images/fuel.png" class="mb-1" alt="" width="35"> -->
                                <i class="nav-icon  i-Calendar-4" style="
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <a href="{{ route('admin.operations.assign_vehicle') }}">
                        <div class="card card-icon mb-4">
                            <div class="card-body text-center">
                                <!-- <img src="<?= asset('assets') ?>/images/fuel.png" class="mb-1" alt="" width="35"> -->
                                <i class="nav-icon  i-Truck" style="
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <a href="{{ route('admin.operations.employee_attendence') }}">
                        <div class="card card-icon mb-4">
                            <div class="card-body text-center">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <a href="{{ route('admin.operations.absent') }}">
                        <div class="card card-icon mb-4">
                            <div class="card-body text-center">
                                <!-- <img src="<?= asset('assets') ?>/images/leave_clender.png" class="mb-1" alt="" width="35"> -->
                                <i class="nav-icon  i-Calendar-4" style="
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <a href="{{ route('admin.operations.employee_attendence_report') }}">
                        <div class="card card-icon mb-4">
                            <div class="card-body text-center">
                                <!-- <img src="<?= asset('assets') ?>/images/leave_clender.png" class="mb-1" alt="" width="35"> -->
                                <i class="nav-icon  i-Calendar-4" style="
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <a href="{{ route('admin.operations.employee_leave') }}">
                        <div class="card card-icon mb-4">
                            <div class="card-body text-center">
                                <img src="<?= asset('assets') ?>/images/leave_clender.png" class="mb-1" alt="" width="35">
