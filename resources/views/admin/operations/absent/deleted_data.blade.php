...
<div class="container">
    <div class="mb-5"> 
        <a href="{{ route( 'admin.hr_pro.absent') }}">
    ...
    <div class="table-responsive">
        ...
        <table id=""  class="display table  nowrap " style="width:100%">
                ...
                <tbody>
                    ...
                    <td>
                        <form action="{{ route( 'admin.hr_pro.view_absent') }}" method="post" class="d-inline">
                            @csrf
...
<script>
    function restore_fun(clicked_id) {
        ...
        swal({
            ...
            $.ajax({
                type:'POST',
                url:"{{ route( 'admin.hr_pro.restore_absent') }}",
