...
<div class="tab" >
  <button  class="tablinks "> <a href="{{ route('admin.operations.add_complaints') }}" style=""> Add New Complaint </a>  </button>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="mt-3 mb-3"> 
                ...
                <a href="{{ route('admin.operations.complaints_history') }}"target="_blank" class="ml-3">
                        <img src="<?= asset('assets') ?>/images/history_icon.png" alt="" width="30">
                </a> 

                <a href="{{ route('admin.operations.trash_complaints') }}" target="_blank" class="ml-3">
          ...
          <div class="table-responsive">
            <table id=""  class="display table  nowrap " style="width:100%">
                ...
                <tbody>
                    ...
                    <td>
                      <form action="{{ route('admin.operations.view_complaints') }}" method="post" class="d-inline">
                            @csrf
                ...
                <tbody>
                    ...
                    <td>
                      <form action="{{ route('admin.operations.view_complaints') }}" method="post" class="d-inline">
                        ...
                        <form action="{{ route('admin.operations.edit_complaints') }}" method="post" class="d-inline">
                            @csrf
                            <input type="text" class="form-control d-none" name="id" value ="{{$complaints->id}}" placeholder="Enter id" >
                            <button type="submit" class="border-0 .bg-white">
...
$('.delete-file').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type:'POST',
                    url:"{{ route('admin.operations.delete_complaints_status') }}",
