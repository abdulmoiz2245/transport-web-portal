...
<div class="tab" >
  <button  class="tablinks "> <a href="{{ route('user.operations.add_employee_leave') }}" style=""> Add New Leave</a>  </button>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="mt-3 mb-3"> 
                ...
                <a href="{{ route( 'user.operations.employee_leave_history') }}"target="_blank" class="ml-3">
                        <img src="<?= asset('assets') ?>/images/history_icon.png" alt="" width="30">
                </a> 

                <a href="{{ route( 'user.operations.trash_employee_leave') }}" target="_blank" class="ml-3">
          ...
          <div class="table-responsive">
            <table id="trade_license"  class="display table  nowrap " style="width:100%">
                ...
                <tbody>
                    ...
                    <td>
                      <form action="{{ route( 'user.operations.view_employee_leave') }}" method="post" class="d-inline">
                            @csrf
                ...
                <tbody>
                    ...
                    <td>
                      <form action="{{ route( 'user.operations.view_employee_leave') }}" method="post" class="d-inline">
                        ...
                        <form action="{{ route( 'user.operations.edit_employee_leave') }}" method="post" class="d-inline">
                            @csrf
                            <input type="text" class="form-control d-none" name="id" value ="{{$leave->id}}" placeholder="Enter id" >
                            <button type="submit" class="border-0 .bg-white">
...
$('.delete-file').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type:'POST',
                    url:"{{ route( 'user.operations.delete_employee_leave_status') }}",
