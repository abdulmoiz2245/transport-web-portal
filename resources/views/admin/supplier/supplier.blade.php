...
<div class="tab" >
  <button  class="tablinks "> <a href="{{ route('admin.supplier.add_supplier') }}" style=""> Add New Supplier </a>  </button>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="mt-3 mb-3"> 
                ...
                <a href="{{ route( 'admin.supplier.trash_supplier') }}" target="_blank" class="ml-3">
