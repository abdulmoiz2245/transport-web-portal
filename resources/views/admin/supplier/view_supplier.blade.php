                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-md-6 col-12 mb-3">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <p>{{ $data['customer_info']->product }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12 mb-3">
                            <div class="row">
                                <div class="col-4">
                                    <h5 class=""><b>Services :</b></h5>

                                </div>
                                <div class="col-6">
                                    <p>{{ $data['customer_info']->services }}</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-8">
                                    ...
                                    @else
                                        ...
                                        <a  href="{{ asset('main_admin/supplier')}}/{{$data['customer_info']->business_license_copy}}" download>
                                            <button class="btn">
                                                Download Documennt
                                            </button>
                                        </a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-8">
                                    ...
                                    @else
                                        ...
                                        <a  href="{{ asset('main_admin/supplier')}}/{{$data['customer_info']->business_contract_copy}}" download>
                                            <button class="btn">
                                                Download Documennt
                                            </button>
                                        </a>
