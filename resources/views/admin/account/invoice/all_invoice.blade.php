...
<div class="tab" >
  ...
  <form action="" method="get">
    ...
    <button type="submit" class="tablinks <?php 
      ...
      ?>" onclick="openCity(event, 'approved')"> Approved / Existing Invoice 
    </button>
  </form>
  <form action="" method="get">
    ...
    <button type="submit" class="tablinks <?php 
      ...
      ?>" onclick="openCity(event, 'pending')">  Pending Invoice 
    </button>
  </form>
  <form action="" method="get">
    ...
    <button type="submit" class="tablinks <?php 
      ...
      ?>" onclick="openCity(event, 'rejected')"> Rejected Invoice 
    </button>
  </form>
...
<script>
    ...
    $('.delete-file').click(function () {
        ...
        swal({
            ...
            $.ajax({
                type:'POST',
                url:"{{ route('admin.account.discard_invoice') }}",
