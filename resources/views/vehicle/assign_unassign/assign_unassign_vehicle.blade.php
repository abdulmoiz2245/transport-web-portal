...
<div class="container">
    ...
    <div class=""> 
            ...
            <a href="{{ route( 'user.vehicle.trash_assign_unassign') }}" target="_blank" class="ml-3">
    ...
    <div class="table-responsive">
        <table class="display table  nowrap  " style="width:100%">
            ...
            <tbody>
                ...
                <tr> 
                    ...
                    <td>
                        <form action="{{ route( 'user.vehicle.view_assigned_unassigned_vehicle') }}" method="post" class="d-inline">
                            @csrf
                        ...
                        <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(645px, 144px, 0px);">
                            ...
                            <a href="{{ route('user.vehicle.unassign_vehicle',['assign_id'=>$assign_vehicle->id ]) }}" class="dropdown-item ul-widget__link--font unassign_vehicle"  vehicle_id = "{{  $assign_vehicle->vehicle_id }}" id ="{{  $assign_vehicle->id  }}"  onclick="window.open(this.href,'targetWindow',
                                                                `toolbar=no,
                                                                    location=no,
                                                                    status=no,
                                                                    menubar=no,
        ...
        <form action="{{ route('user.vehicle.assign_vehicle_save') }}" method="post" enctype="multipart/form-data">
        @csrf
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12 form-group mb-3">
                                    ...
                                    <select name="vehicle_id" class="form-control" id="vehicle_assign" placeholder="">
                                        @foreach($data['vehicle'] as $vehicle)
        ...
        <div class="modal fade" id="add_trailer"  data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="{{ route('user.vehicle.assign_trailer_save') }}" method="post" enctype="multipart/form-data">
                        <div class="modal-header">
    ...
    $(document).ready(function() {
        ...
        $('.delete-file').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type:'POST',
                    url:"{{ route( 'user.vehicle.delete_assign_unassign_vehicle') }}",
        ...
        $( "#vehicle_assign" ).change(function() {
            $.ajax({
                    url: "{{ route('user.vehicle.get_vehicle') }}",
                    type: 'GET',
                    data: { id: $(this).val() },
                    success: function(data)
                    {
