...
<div class="container">
    ...
    <form action="{{route('user.operations.save_new_booking')}}" method="post"    enctype="multipart/form-data">
    @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-12 trn_number">
                <div class="form-group">
                    ...
                    <input id="from_location" type="text" name="from_location" class="form-control" readonly placeholder="Enter From Location" value="{{ $data['customer_rate_card']->from }}" required>
                </div>
            </div>
            <div class="col-md-6 col-12 trn_number">
                <div class="form-group">
                    <label>To  Location</label>
                    <input id="to_location" type="text" name="to_location" class="form-control" readonly placeholder="Enter To Location" value="{{ $data['customer_rate_card']->to }}" required>
                </div>
            </div>
            <div class="col-md-6 col-12 trn_number">
                <div class="form-group">
                    <label>Ap Fuel</label>
                    <input id="ap_fuel" type="text" name="ap_fuel" class="form-control" readonly placeholder="Enter Ap Fuel" value="{{ $data['customer_rate_card']->ap_fuel }}" required>
                </div>
            </div>
            <div class="col-md-6 col-12 trn_number">
                <div class="form-group">
                    <label>Ap Km</label>
                    <input id="ap_km" type="text" name="ap_km" class="form-control" readonly placeholder="Enter Ap KM" value="{{ $data['customer_rate_card']->ap_km }}" required>
                </div>
            </div>
            <div class="col-md-6 col-12 trn_number">
                <div class="form-group">
                    <label>Driver Comission</label>
                    <input id="driver_comission" type="text" name="driver_comission" class="form-control" readonly placeholder="Enter Driver Comission" value="{{ $data['customer_rate_card']->driver_comission }}" required>
                </div>
            </div>
            <div class="col-12">
    ...
    $( document ).ready(function() {
        ...
        $( "#select_vehicle" ).change(function() 
        {
           ...
           var  trailer_id = null;
            ...
            $.ajax({
                    url: "{{ route('user.vehicle.get_vehicle_driver') }}",
                    type: 'GET',
                    data: { id: $(this).val(),
                            driver:  driver_id},
