...
<div class="tab" >
  <button  class="tablinks "> <a href="{{ route('user.purchase.add_purchase') }}" style=""> Add New Purchase </a>  </button>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="mt-3 mb-3"> 
                ...
                <a href="{{ route( 'user.purchase.trash_purchase') }}" target="_blank" class="ml-3">
                ...
                <table  class="display table2 table  nowrap " style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route( 'user.purchase.view_vehicle_purchase') }}" method="post" class="d-inline">
                                    @csrf
                                    <input type="text" class="form-control d-none" name="id" value ="{{$trade_license->id}}" placeholder="Enter id" >
                                    <button type="submit" class="border-0 bg-white">
                                        <img src="<?= asset('assets') ?>/images/eye_icon.png" alt="" width="34">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route( 'user.purchase.edit_vehicle_purchase') }}" method="post" class="d-inline">
                                @csrf
                                    <input type="text" class="form-control d-none" name="id" value ="{{$trade_license->id}}" placeholder="Enter id" >
                                    <button type="submit" class="border-0 bg-white">
                                            <img src="<?= asset('assets') ?>/images/edit_icon.png" alt="" width="34">
...
<script>
    ...
    $('.delete-vehicle-file').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type:'POST',
                    url:"{{ route( 'user.purchase.delete_vehicle_purchase_status') }}",
                    data:{id:file_id, _token :"{{ csrf_token() }}"},
                    success:function(data){
                            if (data.status == 1) {
                                swal({
