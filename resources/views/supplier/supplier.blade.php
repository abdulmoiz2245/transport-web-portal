...
<div class="tab" >
  ...
  <form action="" method="get">
    ...
    <button type="submit" class="tablinks <?php 
      ...
      ?>" onclick="openCity(event, 'approved')"> Approved / Existing Supplier 
    </button>
  </form>
  <form action="" method="get">
    ...
    <button type="submit" class="tablinks <?php 
      ...
      ?>" onclick="openCity(event, 'pending')">  Pending Supplier 
    </button>
  </form>
  <form action="" method="get">
    ...
    <button type="submit" class="tablinks <?php 
      ...
      ?>" onclick="openCity(event, 'rejected')"> Rejected Supplier 
    </button>
  </form>
                        ...
                        <table class="display table responsive nowrap  " style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('user.supplier.view_supplier') }}" method="post" class="d-inline">
                                            @csrf
                                        ...
                                        <form action="{{ route('user.supplier.edit_supplier') }}" method="post" class="d-inline">
                                            @csrf
                                            <input type="text" class="form-control d-none" name="id" value ="{{$customer_info->id}}" placeholder="Enter id" >
                                            <button type="submit" class="border-0 .bg-white">
...
<script>
    ...
    $('.delete-file').click(function () {
        ...
        swal({
            ...
            $.ajax({
                type:'POST',
                url:"{{ route('user.supplier.delete_supplier') }}",
