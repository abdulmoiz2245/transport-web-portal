...
<div class="tab" >
  <button  class="tablinks "> <a href="{{ route('user.hr_pro.add_non_mobile_trained_individual') }}" style=""> Add Trained Individual </a>  </button>
  <form action="" method="get">
    ...
    <button type="submit" class="tablinks <?php 
      ...
      ?>" onclick="openCity(event, 'approved')"> Approved / Existing Trained Individual 
    </button>
  </form>
  <form action="" method="get">
    ...
    <button type="submit" class="tablinks <?php 
      ...
      ?>" onclick="openCity(event, 'pending')">  Pending Trained Individual 
    </button>
  </form>
  <form action="" method="get">
    ...
    <button type="submit" class="tablinks <?php 
      ...
      ?>" onclick="openCity(event, 'rejected')"> Rejected Trained Individual 
    </button>
  </form>
...
<script>
    ...
    $('.delete-file').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type:'POST',
                    url:"{{ route('user.hr_pro.delete_non_mobiles_trained_individual') }}",
