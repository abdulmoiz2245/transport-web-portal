<div class="container">
    <div class="mb-4">
        <a href="{{ route( 'user.hr_pro.trade_license_partners' ,$data['trade_license_partners']->trade_license_id ) }}">
            <img  src="<?= asset('assets') ?>/images/back-button.png" alt="" width="30">
        </a>
    </div>
</div>
<div class="container">
    <form action="{{ route('user.hr_pro.update_trade_license_partners') }}" method="post" id="customer_rate_card" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
            <div class="col-md-6 col-12">
                @if( $data['trade_license_partners']->id_copy != null)
                <div class="row">
                    <div class="col-12">
