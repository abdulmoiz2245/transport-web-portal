...
<div class="container">
    <div class="mb-5">
        <a href="{{ route('user.hr_pro.trade_license__sponsors__partners') }}" class="mb-5">
...
<script>
    ...
    function restore_fun(clicked_id) {
        ...
        swal({
            ...
            $.ajax({
                type:'POST',
                url:"{{ route( 'user.hr_pro.restore_trade_license_partners') }}",
    ...
    function delete_fun(clicked_id) {
        ...
        swal({
            ...
            $.ajax({
                type:'POST',
                url:"{{ route( 'user.hr_pro.delete_trade_license_partners') }}",
                data:{id:file_id, _token :"{{ csrf_token() }}"},
                success:function(data){
                        if (data.status == 1) {
                            swal({
