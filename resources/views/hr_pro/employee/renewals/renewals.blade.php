...
<div class="tab" >
  <button  class="tablinks "> <a href="{{ route( 'user.hr_pro.add_employee_renewals') }}" style=""> Add New </a>  </button>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="mt-3 mb-3"> 
                ...
                <a href="{{ route( 'user.hr_pro.employee_renewals_history') }}"target="_blank" class="ml-3">
                        <img src="<?= asset('assets') ?>/images/history_icon.png" alt="" width="30">
                </a> 

                <a href="{{ route( 'user.hr_pro.trash_employee_renewals') }}" target="_blank" class="ml-3">
          ...
          <div class="table-responsive">
            <table id="trade_license"  class="display table  nowrap " style="width:100%">
                ...
                <tbody>
                    ...
                    @if($employees->id ==  $renew_employee->emp_id && $employees->row_status != 'deleted')
            ...
            <table id="trade_license"  class="display table  nowrap " style="width:100%">
                ...
                @foreach($data['renew_employee'] as $renew_employee)
                    ...
                    <td>
                        ...
                        <form action="{{ route( 'user.hr_pro.edit_employee_renewals') }}" method="post" class="d-inline">
                            @csrf
                            <input type="text" class="form-control d-none" name="id" value ="{{$renew_employee->id}}" placeholder="Enter id" >
                            <button type="submit" class="border-0 .bg-white">
...
$('.delete-file').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type:'POST',
                    url:"{{ route( 'user.hr_pro.delete_employee_renewals_status') }}",
