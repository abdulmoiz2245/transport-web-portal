...
<div class="tab" >
  <button  class="tablinks "> <a href="{{ route('user.hr_pro.add_employee_deduction') }}" style=""> Add New </a>  </button>
...
<div class="card">
    <div class="card-body">
        ...
        <div class="mt-3 mb-3"> 
                ...
                <a href="{{ route( 'user.hr_pro.employee_deduction_history') }}"target="_blank" class="ml-3">
                        <img src="<?= asset('assets') ?>/images/history_icon.png" alt="" width="30">
                </a> 

                <a href="{{ route( 'user.hr_pro.trash_employee_deduction') }}" target="_blank" class="ml-3">
          ...
          <div class="table-responsive">
            <table id="trade_license"  class="display table  nowrap " style="width:100%">
                ...
                <tbody>
                    ...
                    <td>
                      <form action="{{ route( 'user.hr_pro.view_employee_deduction') }}" method="post" class="d-inline">
                            @csrf
            ...
            <table id="trade_license"  class="display table  nowrap " style="width:100%">
                ...
                @foreach($data['employee_deduction'] as $employee_deduction)
                    ...
                    <td>
                        ...
                        <form action="{{ route( 'user.hr_pro.edit_employee_deduction') }}" method="post" class="d-inline">
                            @csrf
                            <input type="text" class="form-control d-none" name="id" value ="{{$employee_deduction->id}}" placeholder="Enter id" >
                            <button type="submit" class="border-0 .bg-white">
...
$('.delete-file').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type:'POST',
                    url:"{{ route( 'user.hr_pro.delete_employee_deduction_status') }}",
