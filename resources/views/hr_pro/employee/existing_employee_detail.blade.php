        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <a href="{{ route('user.hr_pro.existing_employee') }}">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <a href="{{ route('user.hr_pro.employee_attendence') }}">
                        <div class="card card-icon mb-4">
                            <div class="card-body text-center">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <a href="{{ route('user.hr_pro.employee_attendence_report') }}">
                        <div class="card card-icon mb-4">
                            <div class="card-body text-center">
                                <!-- <img src="<?= asset('assets') ?>/images/leave_clender.png" class="mb-1" alt="" width="35"> -->
                                <i class="nav-icon  i-Calendar-4" style="
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <a href="{{ route('user.hr_pro.employee_increments') }}">
                        <div class="card card-icon mb-4">
                            <div class="card-body text-center">
                                <!-- <img src="<?= asset('assets') ?>/images/leave_clender.png" class="mb-1" alt="" width="35"> -->
                                <i class="nav-icon  i-Business-Man" style="
                ...
                <!-- <div class="col-lg-3 col-md-6 col-sm-6">
                    <a href="{{ route('user.hr_pro.employee_other') }}">
                        <div class="card card-icon mb-4">
                            <div class="card-body text-center">
                                <i class="nav-icon  i-Business-Man" style="
                                    font-size: 39px;
