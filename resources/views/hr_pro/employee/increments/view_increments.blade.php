<div class="container card mt-5">
    ...
    @foreach($data['employees'] as $employees)
        @if($employees->id ==  $data['employee_increments']->emp_id)
    <div class="row mb-3">
        <div class="col-6">
            <div class="row">
                <div class="col-5">
        ...
        <div class="row">
                ...
                <div class="col-6">
                    <p>{{ $data['employee_increments']->amount}}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row  mb-3">
        <div class="col-6">
            <div class="row">
                ...
                <div class="col-6">
                    <p>{{ $data['employee_increments']->reason}}</p>
                </div>
            </div>
        </div>
        <div class="col-6">
            <div class="row">
                ...
                <div class="col-6">
                    <p>{{  $data['employee_increments']->applicable_month }}</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-8">
                    ...
                    @else
                        ...
                        <a download href="{{ asset('main_admin/hr_pro/employee/main')}}/{{$data['employee_increments']->upload}}">
                            <button class="btn">
                                Download Documennt
                            </button>
                        </a>
