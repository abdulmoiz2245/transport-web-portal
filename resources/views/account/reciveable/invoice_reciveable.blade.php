...
<div class="tab" >
  ...
  <a href="{{ route('user.account.reciveable_invoice') }}">
...
<div class="d-flex mt-3 mb-3" style="justify-content: space-between;">
    <div>
        <a href="{{ route( 'user.account.reciveable') }}">
    ...
    <div class="category-filter" style="display:flex">
        <div  style="display:flex">
            ...
            <select id="categoryFilter" class="form-control" style="
                ...
                <option value="partial_recived">Partial paid</option>
                <option value="recived">Paid</option>
                <option value="not_recived">Not Paid</option>
            </select>
        </div>
...
<div class="modal fade  " id="exampleModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{ route('user.account.recive_invoice_payment') }}" enctype="multipart/form-data" method="post">
          @csrf
