...
<div class="">
    ...
    <div class="category-filter" style="display:flex">
        <div  style="display:flex">
            ...
            <select id="categoryFilter" class="form-control" style="
                ...
                <option value="not_cleard">Not Cleared</option>
            </select>
        </div>
    ...
    <table id="filterTable"  class="display table">
        ...
        <tbody>
            ...
            @if( $hr_fund->row_status != 'deleted'  && $hr_fund->status != 'not_paid')
...
<div class="modal fade  " id="exampleModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="{{ route('user.account.cheque_issue_hr_fund') }}" enctype="multipart/form-data" method="post">
          @csrf
