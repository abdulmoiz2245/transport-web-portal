                        ...
                        <table class="display table  nowrap  " style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr> 
                                    ...
                                    <td>
                                        <form action="{{ route( 'user.inventory.uncategorized.view_uncategorized') }}" method="post" class="d-inline">
                                            @csrf
...
<script>
    ...
    $('.delete-file').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type:'POST',
                    url:"{{ route( 'user.inventory.uncategorized.delete_uncategorized_status') }}",
