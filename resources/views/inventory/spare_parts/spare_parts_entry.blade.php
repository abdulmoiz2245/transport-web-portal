...
<div class="container">
    <div class="d-flex" style="justify-content: space-between;">
        <div>
            ...
            <a href="{{ route( 'user.inventory.spare_parts.add_spare_parts_entry') }}" class="ml-3">
                <img src="<?= asset('assets') ?>/images/add-button.png" alt="" title="Add Spare Parts Entry" width="30">
            </a>
        </div>

        <div class=""> 
            <a href="{{ route( 'user.inventory.spare_parts.spare_parts_entry_history') }}"target="_blank" class="ml-3">
                            ...
                            <tbody>
                                ...
                                <tr> 
                                    ...
                                    @if(Inventory_spare_parts::find($spare_parts->part_description_id) != null)
                                        ...
                                        {{Inventory_spare_parts::find($spare_parts->part_description_id)->part_description }}<//
                                    @else
                                    Part Deleted
                                    @endif
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route( 'user.inventory.spare_parts.edit_spare_parts_entry') }}" method="post" class="d-inline">
                                            @csrf
...
<script>
    ...
    $('.delete-file').click(function () {
            ...
            swal({
                ...
                $.ajax({
                    type:'POST',
                    url:"{{ route( 'user.inventory.spare_parts.delete_spare_parts_entry_status') }}",
